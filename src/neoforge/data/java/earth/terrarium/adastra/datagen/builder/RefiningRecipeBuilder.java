...
public class RefiningRecipeBuilder extends CodecRecipeBuilder {
    ...
    public RefiningRecipeBuilder(int cookingTime, int energy, SizedFluidIngredient input, ResourceStack<FluidResource> result) {
    ...
    public void save(RecipeOutput recipeOutput, ResourceLocation id) {
        ...
        recipeOutput.accept(id, recipe, builder
            .build(ResourceLocation.fromNamespaceAndPath(id.getNamespace(), "recipes/refining/" + id.getPath())));
    }
}