...
@OnlyIn(Dist.CLIENT)
public class EnergyRouterGuiWindow extends AbstractContainerScreen<EnergyRouterGui.GuiContainer> {
    ...
    public EnergyRouterGuiWindow(EnergyRouterGui.GuiContainer container, Inventory inventory, Component text) {
    ...
    public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
        ...
        EnergyCableTileEntity blockEntity = (EnergyCableTileEntity) this.getMenu().getBlockEntity();
    ...
    protected void renderBg(PoseStack ms, float p_97788_, int p_97789_, int p_97790_) {
        ...
        EnergyCableTileEntity blockEntity = this.getMenu().getBlockEntity();
