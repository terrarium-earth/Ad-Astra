...
public class CoalGeneratorScreen extends AbstractMachineScreen<CoalGeneratorScreenHandler> {
    ...
    private static final Identifier TEXTURE = new ModIdentifier("textures/screens/coal_generator_gui.png");
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        GuiUtil.drawFire(matrices, this.x + FIRE_LEFT, this.y + FIRE_TOP, coalGeneratorBlockEntity.getBurnTime(), coalGeneratorBlockEntity.getBurnTimeTotal());
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (GuiUtil.isHover(this.getFireBounds(), mouseX, mouseY)) {
            this.renderTooltip(matrices, new TranslatableText("gauge.beyond_earth.burn_time", coalGeneratorBlockEntity.getBurnTime(), coalGeneratorBlockEntity.getBurnTimeTotal()), mouseX, mouseY);
        }
    }
