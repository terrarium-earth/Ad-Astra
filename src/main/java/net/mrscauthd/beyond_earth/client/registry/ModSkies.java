...
import net.mrscauthd.beyond_earth.client.renderer.sky.GlacioSky;
...
import net.mrscauthd.beyond_earth.client.renderer.sky.VenusSky;
...
public class ModSkies {
    ...
    public static void register() {
        ...
        // Moon.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.MOON_KEY,
                new ModSky().withStars().withSun().withEarth(9.0f));
        // Mars.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.MARS_KEY,
                new MarsSky().withVanillaStars().withSun().withEarth(1.0f).withPhobos().withDeimos());
        // Venus.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.VENUS_KEY,
                new VenusSky().withVanillaStars().withSun().withMercury().withEarth(2.0f));
        // Mercury.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.MERCURY_KEY, new ModSky().withStars().withSun(60));
        // Glacio.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.GLACIO_KEY,
                new GlacioSky().withVanillaStars().withSun().withVicinus());

        // Earth Orbit.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.EARTH_ORBIT_KEY,
                new OrbitSky().withStars().withSun().withEarthOrbit());
        // Moon Orbit.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.MOON_ORBIT_KEY,
                new OrbitSky().withStars().withSun().withMoonOrbit());
        // Mars Orbit.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.MARS_ORBIT_KEY,
                new OrbitSky().withStars().withSun().withMarsOrbit());
        // Venus Orbit.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.VENUS_ORBIT_KEY,
                new OrbitSky().withStars().withSun().withVenusOrbit());
        // Mercury Orbit.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.MERCURY_ORBIT_KEY,
                new OrbitSky().withStars().withSun().withMercuryOrbit());
        // Glacio Orbit.
        DimensionRenderingRegistry.registerSkyRenderer(ModUtils.GLACIO_ORBIT_KEY,
                new OrbitSky().withStars().withSun(60).withGlacioOrbit());
        ...
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.MERCURY_KEY.getValue(),
                new HorizonDimensionEffects(new Vec3d(0.572549019608, 0.082352941176, 0.082352941176)));
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.GLACIO_KEY.getValue(),
                new GlacioDimensionEffects());
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.EARTH_ORBIT_KEY.getValue(),
                new ModDimensionEffects());
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.MOON_ORBIT_KEY.getValue(),
                new ModDimensionEffects());
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.MARS_ORBIT_KEY.getValue(),
                new ModDimensionEffects());
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.VENUS_ORBIT_KEY.getValue(),
                new ModDimensionEffects());
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.MERCURY_ORBIT_KEY.getValue(),
                new ModDimensionEffects());
        DimensionRenderingRegistry.registerDimensionEffects(ModUtils.GLACIO_ORBIT_KEY.getValue(),
                new ModDimensionEffects());
