...
public class BeyondEarthClient implements ClientModInitializer {
        ...
        public void onInitializeClient() {
                ...
                BlockEntityRendererRegistry.register(ModBlockEntities.GLOBE_BLOCK_ENTITY,
                                GlobeBlockEntityRenderer::new);
                ...
                EntityModelLayerRegistry.registerModelLayer(SpaceSuitModel.SPACE_SUIT_P1.LAYER_LOCATION,
                                SpaceSuitModel.SPACE_SUIT_P1::createBodyLayer);
                EntityModelLayerRegistry.registerModelLayer(SpaceSuitModel.SPACE_SUIT_P2.LAYER_LOCATION,
                                SpaceSuitModel.SPACE_SUIT_P2::createBodyLayer);
                ...
                BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.FUEL_STILL,
                                ModFluids.FLOWING_FUEL);
