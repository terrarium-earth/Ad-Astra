...
public class RocketEntityModelTier4 extends RocketEntityModel<RocketEntityTier4> {

        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new ModIdentifier("rocket_t4"), "main");
