...
public class SpaceSuitModel {
    ...
    public static class SPACE_SUIT_P1<T extends LivingEntity> extends BipedEntityModel<T> {
        ...
        private static final Identifier NETHERITE_SPACE_SUIT = new ModIdentifier(
                "textures/models/armor/netherite_space_suit_head.png");

        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new ModIdentifier("space_suit_p1"),
                "main");
        ...
        public static TexturedModelData createBodyLayer() {
            ...
            modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(20, 44).cuboid(-3.0f, -2.0f, -2.0f, 4.0f,
                    12.0f, 4.0f, new Dilation(0.26f)), ModelTransform.pivot(-5.0f, 2.0f, 0.0f));

            modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(32, 0).cuboid(-1.0f, -2.0f, -2.0f, 4.0f,
                    12.0f, 4.0f, new Dilation(0.26f)), ModelTransform.pivot(5.0f, 2.0f, 0.0f));

            modelPartData.addChild("right_leg",
                    ModelPartBuilder.create().uv(48, 44)
                            .cuboid(-2.0f, 6.0f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(0.4f))
                            .uv(48, 54).cuboid(-2.0f, 6.0f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(0.27f)),
        ...
        public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red,
            ...
            if (stack.getItem().equals(ModArmour.OXYGEN_MASK)) {
                this.head.render(matrices,
                        getVertex(RenderLayer.getEntityTranslucent(SPACE_SUIT), stack.hasEnchantments()), light,
                        overlay);
            } else if (stack.getItem().equals(ModArmour.NETHERITE_OXYGEN_MASK)) {
                this.head.render(matrices,
                        getVertex(RenderLayer.getEntityTranslucent(NETHERITE_SPACE_SUIT), stack.hasEnchantments()),
                        light, overlay);
            } else {
        ...
        public static VertexConsumer getVertex(RenderLayer renderLayer, boolean hasEnchantments) {
            VertexConsumerProvider vertexConsumerProvider = MINECRAFT_CLIENT.getBufferBuilders()
                    .getEntityVertexConsumers();
            return hasEnchantments
                    ? VertexConsumers.union(vertexConsumerProvider.getBuffer(RenderLayer.getEntityGlint()),
    ...
    public static class SPACE_SUIT_P2<T extends LivingEntity> extends BipedEntityModel<T> {
        ...
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new ModIdentifier("space_suit_p2"),
                "main");
        ...
        public static TexturedModelData createBodyLayer() {
            ...
            modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-2.0f, 0.0f, -2.0f, 4.0f,
                    12.0f, 4.0f, new Dilation(0.6f)), ModelTransform.pivot(-1.9f, 12.0f, 0.0f));

            modelPartData.addChild("left_leg",
                    ModelPartBuilder.create().uv(0, 16)
                            .cuboid(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f, new Dilation(0.6f)).mirrored(false),
