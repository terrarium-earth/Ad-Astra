...
public class SpaceSuitModel {
        ...
        public static class SPACE_SUIT_P1<T extends LivingEntity> extends BipedEntityModel<T> {
                ...
                public SPACE_SUIT_P1(ModelPart root) {
                        super(new EntityRendererFactory.Context(MINECRAFT_CLIENT.getEntityRenderDispatcher(), MINECRAFT_CLIENT.getItemRenderer(), MINECRAFT_CLIENT.getResourceManager(),
                                        MINECRAFT_CLIENT.getEntityModelLoader(), MINECRAFT_CLIENT.textRenderer).getPart(EntityModelLayers.PLAYER_INNER_ARMOR));
                ...
                public static TexturedModelData createBodyLayer() {
                        ...
                        modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 16).cuboid(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new Dilation(0.5f)).uv(0, 0).cuboid(-4.0f, -8.0f, -4.0f, 8.0f,
                                        8.0f, 8.0f, new Dilation(0.75f)), ModelTransform.of(0.0f, 0.0f, 0.0f, -0.0175f, 0.0873f, 0.0f));

                        modelPartData.addChild("body",
                                        ModelPartBuilder.create().uv(0, 32).cuboid(-4.0f, 0.0f, -2.0f, 8.0f, 12.0f, 4.0f, new Dilation(0.25f)).uv(28, 28)
                                                        .cuboid(-4.0f, 0.0f, -2.0f, 8.0f, 12.0f, 4.0f, new Dilation(0.25f)).uv(50, 29).cuboid(-3.0f, 5.0f, -2.5f, 6.0f, 4.0f, 1.0f, new Dilation(0.25f))
                                                        .uv(0, 55).cuboid(-2.5f, 1.0f, 2.55f, 5.0f, 8.0f, 1.0f, new Dilation(0.75f)),
                                        ModelTransform.pivot(0.0f, 0.0f, 0.0f));

                        modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(20, 44).cuboid(-3.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f, new Dilation(0.26f)),
                                        ModelTransform.pivot(-5.0f, 2.0f, 0.0f));

                        modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(32, 0).cuboid(-1.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f, new Dilation(0.26f)),
                                        ModelTransform.pivot(5.0f, 2.0f, 0.0f));

                        modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(48, 44).cuboid(-2.0f, 6.0f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(0.4f)).uv(48, 54).cuboid(-2.0f, 6.0f, -2.0f,
                                        4.0f, 6.0f, 4.0f, new Dilation(0.27f)), ModelTransform.pivot(-2.0f, 12.0f, 0.0f));

                        modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(48, 44).cuboid(-2.0f, 6.0f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(0.4f)).uv(48, 54).cuboid(-2.0f, 6.0f, -2.0f,
                                        4.0f, 6.0f, 4.0f, new Dilation(0.27f)), ModelTransform.pivot(2.0f, 12.0f, 0.0f));
                ...
                public static VertexConsumer getVertex(RenderLayer renderLayer, boolean hasEnchantments) {
                        ...
                        return hasEnchantments ? VertexConsumers.union(vertexConsumerProvider.getBuffer(RenderLayer.getEntityGlint()), vertexConsumerProvider.getBuffer(renderLayer))
        ...
        public static class SPACE_SUIT_P2<T extends LivingEntity> extends BipedEntityModel<T> {
                ...
                public static TexturedModelData createBodyLayer() {
                        ...
                        modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f, new Dilation(0.6f)),
                                        ModelTransform.pivot(-1.9f, 12.0f, 0.0f));

                        modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f, new Dilation(0.6f)).mirrored(false),
                                        ModelTransform.pivot(1.9f, 12.0f, 0.0f));
