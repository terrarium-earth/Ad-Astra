...
public class RocketEntityModelTier2 extends RocketEntityModel<RocketEntityTier2> {

    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new ModIdentifier("rocket_t2"), "main");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData rocket = modelPartData.addChild("rocket",
                ModelPartBuilder.create().uv(0, 167).cuboid(-12.0f, -21.0f, -1.0f, 3.0f, 3.0f, 2.0f, new Dilation(0.0f)).uv(184, 0).cuboid(-9.0f, -55.0f, -9.0f, 18.0f, 47.0f, 18.0f, new Dilation(0.0f)).uv(184, 65)
                        .cuboid(-9.0f, -10.0f, -9.0f, 18.0f, 0.0f, 18.0f, new Dilation(0.0f)).uv(36, 23).cuboid(-2.0f, -81.0f, -2.0f, 4.0f, 2.0f, 4.0f, new Dilation(0.0f)).uv(36, 0).cuboid(-2.0f, -94.0f, -2.0f, 4.0f, 4.0f, 4.0f, new Dilation(-0.375f))
                        .uv(36, 8).cuboid(-1.0f, -93.0f, -1.0f, 2.0f, 13.0f, 2.0f, new Dilation(0.0f)).uv(36, 29).cuboid(-3.0f, -79.0f, -3.0f, 6.0f, 8.0f, 6.0f, new Dilation(0.0f)).uv(22, 128)
                        ...
                        .uv(0, 85).cuboid(-10.0f, -56.0f, -10.0f, 20.0f, 2.0f, 20.0f, new Dilation(0.0f)).uv(22, 116).cuboid(-5.0f, -7.0f, -5.0f, 10.0f, 2.0f, 10.0f, new Dilation(0.0f)).uv(22, 107)
                        .cuboid(-4.0f, -8.0f, -4.0f, 8.0f, 1.0f, 8.0f, new Dilation(0.0f)).uv(230, 88).cuboid(-6.0f, -43.0f, -9.5f, 12.0f, 12.0f, 1.0f, new Dilation(0.0f)).uv(238, 101).cuboid(-4.0f, -41.0f, -9.5f, 8.0f, 8.0f, 1.0f, new Dilation(0.0f))
                        .uv(0, 152).cuboid(-13.0f, -18.0f, -3.0f, 4.0f, 9.0f, 6.0f, new Dilation(0.0f)),
