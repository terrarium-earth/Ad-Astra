...
import net.mrscauthd.beyond_earth.world.features.MarsBlockBlobFeature;
import net.mrscauthd.beyond_earth.world.features.VenusDeltas;
...
public class ModFeatures {
    ...
    public static final PlacedFeature MARS_ROCK = new PlacedFeature(RegistryUtil.getEntry(BuiltinRegistries.CONFIGURED_FEATURE, MARS_ROCK_CONFIGURED_FEATURE), List.of(CountPlacementModifier.of(2), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of()));
    ...
    // Small.
    public static final ConfiguredFeature<?, ?> VENUS_DELTAS_SMALL_CONFIGURED_FEATURE = createFeatureConfiguredFeature(VENUS_DELTAS_SMALL_ID, VENUS_DELTAS_FEATURE, new BasaltColumnsFeatureConfig(ConstantIntProvider.create(1), UniformIntProvider.create(1, 4)));
    public static final PlacedFeature VENUS_DELTAS_SMALL = new PlacedFeature(RegistryUtil.getEntry(BuiltinRegistries.CONFIGURED_FEATURE, VENUS_DELTAS_SMALL_CONFIGURED_FEATURE), List.of(CountMultilayerPlacementModifier.of(4), BiomePlacementModifier.of()));

    // Large.
    public static final ConfiguredFeature<?, ?> VENUS_DELTAS_LARGE_CONFIGURED_FEATURE = createFeatureConfiguredFeature(VENUS_DELTAS_LARGE_ID, VENUS_DELTAS_FEATURE, new BasaltColumnsFeatureConfig(UniformIntProvider.create(2, 3), UniformIntProvider.create(5, 10)));
    public static final PlacedFeature VENUS_DELTAS_LARGE = new PlacedFeature(RegistryUtil.getEntry(BuiltinRegistries.CONFIGURED_FEATURE, VENUS_DELTAS_LARGE_CONFIGURED_FEATURE), List.of(CountMultilayerPlacementModifier.of(2), BiomePlacementModifier.of()));
