...
import net.mrscauthd.beyond_earth.entities.mobs.AlienEntity;
...
import net.mrscauthd.beyond_earth.entities.mobs.PygroBruteEntity;
import net.mrscauthd.beyond_earth.entities.mobs.PygroEntity;
