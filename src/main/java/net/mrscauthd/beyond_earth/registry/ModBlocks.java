...
public class ModBlocks {
        ...
        public static final Block OXYGEN_BUBBLE_DISTRIBUTOR = new OxygenBubbleDistributorBlock(
                        FabricBlockSettings.of(Material.METAL).sounds(BlockSoundGroup.METAL).strength(5.0f, 1.0f).requiresTool());
        ...
        public static final Block MOON_ICE_SHARD_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
        ...
        public static final Block MARS_DIAMOND_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
        ...
        public static final Block MARS_ICE_SHARD_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
                        UniformIntProvider.create(0, 2));
        ...
        public static final Block VENUS_COAL_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
                        UniformIntProvider.create(0, 2));
        ...
        public static final Block VENUS_DIAMOND_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
                        UniformIntProvider.create(3, 7));
        ...
        public static final Block GLACIO_ICE_SHARD_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
                        UniformIntProvider.create(0, 2));
        public static final Block GLACIO_COAL_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
                        UniformIntProvider.create(0, 2));
        ...
        public static final Block GLACIO_LAPIS_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.0f, 3.0f).requiresTool(),
