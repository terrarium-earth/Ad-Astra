...
public class ClientEventBusMoonOrbit {
    ...
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(BossToolsMod.ModId, "moon_orbit");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation MOON_TEXTURE = new ResourceLocation(BossToolsMod.ModId, "textures/sky/moon.png");
