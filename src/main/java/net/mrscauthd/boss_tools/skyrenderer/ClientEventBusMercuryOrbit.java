...
public class ClientEventBusMercuryOrbit {
	...
	private static final ResourceLocation MERCURY_TEXTURE = new ResourceLocation(BossToolsMod.ModId, "textures/sky/mercury.png");
			...
			public ISkyRenderHandler getSkyRenderHandler() {
				return new ISkyRenderHandler() {
					...
					public void render(int ticks, float partialTicks, MatrixStack matrixStack, ClientWorld world, Minecraft mc) {
						...
						mc.getTextureManager().bindTexture(MERCURY_TEXTURE);
