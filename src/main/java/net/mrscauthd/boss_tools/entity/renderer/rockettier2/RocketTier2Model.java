...
public class RocketTier2Model<T extends RocketTier2Entity> extends EntityModel<T> {
	...
	public RocketTier2Model() {
		...
		rocket.setTextureOffset(36, 29).addBox(-3.0F, -79.0F, -3.0F, 6.0F, 8.0F, 6.0F, 0.0F, false);
		...
		rocket.setTextureOffset(0, 85).addBox(-10.0F, -56.0F, -10.0F, 20.0F, 2.0F, 20.0F, 0.0F, false);
		...
		cube_r2.setTextureOffset(0, 167).addBox(-12.0F, -21.0F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
		cube_r2.setTextureOffset(0, 152).addBox(-13.0F, -18.0F, -3.0F, 4.0F, 9.0F, 6.0F, 0.0F, false);

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(0.0F, 0.0F, 0.0F);
		rocket.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.0F, 3.1416F, 0.0F);
		cube_r3.setTextureOffset(0, 167).addBox(-12.0F, -21.0F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
		cube_r3.setTextureOffset(0, 152).addBox(-13.0F, -18.0F, -3.0F, 4.0F, 9.0F, 6.0F, 0.0F, false);

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(0.0F, -75.0F, 0.0F);
		...
		cube_r5.setRotationPoint(0.0F, -75.0F, 0.0F);
		...
		cube_r6.setRotationPoint(0.0F, -75.0F, 0.0F);
		...
		cube_r7.setRotationPoint(0.0F, -75.0F, 0.0F);
		...
		cube_r8.setRotationPoint(0.0F, -55.0F, 0.0F);
		...
		cube_r9.setRotationPoint(0.0F, -55.0F, 0.0F);
		...
		cube_r10.setRotationPoint(0.0F, -55.0F, 0.0F);
		...
		cube_r11.setRotationPoint(0.0F, -55.0F, 0.0F);
