...
public class Gravity {
    public static void Gravity(LivingEntity entity, GravityType type, Level world) {
        ...
        if (Methodes.isWorld(world, new ResourceLocation(AstroCraftMod.MODID,"mars"))) {
            gravityMath(type, entity, mars, -2.0f);
        }

        if (Methodes.isWorld(world, new ResourceLocation(AstroCraftMod.MODID,"mercury"))) {
            gravityMath(type, entity, mercury, -2.5f);
        }

        if (Methodes.isWorld(world, new ResourceLocation(AstroCraftMod.MODID,"venus"))) {
