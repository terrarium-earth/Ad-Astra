...
@Mod.EventBusSubscriber(modid = AstroCraftMod.MODID, value = Dist.CLIENT)
    ...
    public static void Overlay(RenderGameOverlayEvent.PostLayer event) {
        ...
        if (!event.isCancelable() && event.getOverlay() == ForgeIngameGui.HELMET_ELEMENT) {
            ...
            if (entity.getVehicle() instanceof LanderEntity && !entity.getVehicle().isOnGround() && !entity.isEyeInFluid(FluidTags.WATER)) {
                ...
                RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/overlay/warning.png"));
        ...
        if (!event.isCancelable() && event.getOverlay() == ForgeIngameGui.HELMET_ELEMENT) {
            ...
            if (Methodes.isRocket(entity.getVehicle())) {
                ...
                if (timer > -1 && timer < 20) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer10.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 20 && timer < 40) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer9.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 40 && timer < 60) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer8.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 60 && timer < 80) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer7.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 80 && timer < 100) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer6.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 100 && timer < 120) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer5.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 120 && timer < 140) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer4.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 140 && timer < 160) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer3.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 160 && timer < 180) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer2.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
                if (timer > 180 && timer < 200) {
                    RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/timer/timer1.png"));
                    mc.blit(event.getMatrixStack(), width, high, 0, 0, 60, 38, 60, 38);
                }
        ...
        if (!event.isCancelable() && event.getOverlay() == ForgeIngameGui.HELMET_ELEMENT) {
            ...
            if (chestItem == ModInnet.SPACE_SUIT.get() || chestItem == ModInnet.NETHERITE_SPACE_SUIT.get()) {
                ...
                ResourceLocation empty = new ResourceLocation(AstroCraftMod.MODID, "textures/overlay/oxygentankcheck_empty.png");
                ResourceLocation full = new ResourceLocation(AstroCraftMod.MODID, "textures/overlay/oxygentankcheck_full.png");
        ...
        if (!event.isCancelable() && event.getOverlay() == ForgeIngameGui.HELMET_ELEMENT) {
            ...
            if (Methodes.isRocket(entity.getVehicle()) || entity.getVehicle() instanceof LanderEntity) {
                ...
                if (Methodes.isWorld(world, new ResourceLocation(AstroCraftMod.MODID, "moon"))) {
                    planet = new ResourceLocation(AstroCraftMod.MODID, "textures/planet_bar/rocket_y_main_moon.png");

                } else if (Methodes.isWorld(world, new ResourceLocation(AstroCraftMod.MODID, "mars"))) {
                    planet = new ResourceLocation(AstroCraftMod.MODID, "textures/planet_bar/rocket_y_main_mars.png");

                } else if (Methodes.isWorld(world, new ResourceLocation(AstroCraftMod.MODID, "mercury"))) {
                    planet = new ResourceLocation(AstroCraftMod.MODID, "textures/planet_bar/rocket_y_main_mercury.png");

                } else if (Methodes.isWorld(world, new ResourceLocation(AstroCraftMod.MODID, "venus"))) {
                    planet = new ResourceLocation(AstroCraftMod.MODID, "textures/planet_bar/rocket_y_main_venus.png");

                } else if (Methodes.isOrbitWorld(world)) {
                    planet = new ResourceLocation(AstroCraftMod.MODID, "textures/planet_bar/rocket_y_main_orbit.png");

                } else {
                    planet = new ResourceLocation(AstroCraftMod.MODID, "textures/planet_bar/rocket_y_main_earth.png");
                }

                RenderSystem.setShaderTexture(0, planet);
                mc.blit(event.getMatrixStack(), 0, (high / 2) - 128 / 2, 0, 0, 16, 128, 16, 128);

                RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/planet_bar/rocket_y.png"));
