...
import net.mrscauthd.astrocraft.entity.renderer.TileEntityBoxRenderer;
import net.mrscauthd.astrocraft.entity.renderer.alien.AlienModel;
import net.mrscauthd.astrocraft.entity.renderer.alienzombie.AlienZombieModel;
import net.mrscauthd.astrocraft.entity.renderer.alienzombie.AlienZombieRenderer;
import net.mrscauthd.astrocraft.entity.renderer.flag.TileEntityHeadModel;
import net.mrscauthd.astrocraft.entity.renderer.flag.TileEntityHeadRenderer;
import net.mrscauthd.astrocraft.entity.renderer.lander.LanderModel;
import net.mrscauthd.astrocraft.entity.renderer.lander.LanderRenderer;
import net.mrscauthd.astrocraft.entity.renderer.mogler.MoglerModel;
import net.mrscauthd.astrocraft.entity.renderer.mogler.MoglerRenderer;
import net.mrscauthd.astrocraft.entity.renderer.pygro.PygroModel;
import net.mrscauthd.astrocraft.entity.renderer.pygro.PygroRenderer;
import net.mrscauthd.astrocraft.entity.renderer.rockettier1.RocketTier1Model;
import net.mrscauthd.astrocraft.entity.renderer.rockettier1.RocketTier1Renderer;
import net.mrscauthd.astrocraft.entity.renderer.rockettier2.RocketTier2Model;
import net.mrscauthd.astrocraft.entity.renderer.rockettier2.RocketTier2Renderer;
import net.mrscauthd.astrocraft.entity.renderer.rockettier3.RocketTier3Model;
import net.mrscauthd.astrocraft.entity.renderer.rockettier3.RocketTier3Renderer;
import net.mrscauthd.astrocraft.entity.renderer.rover.RoverModel;
import net.mrscauthd.astrocraft.entity.renderer.rover.RoverRenderer;
import net.mrscauthd.astrocraft.entity.renderer.spacesuit.SpaceSuitModel;
import net.mrscauthd.astrocraft.entity.renderer.starcrawler.StarCrawlerModel;
import net.mrscauthd.astrocraft.entity.renderer.starcrawler.StarCrawlerRenderer;
...
import net.mrscauthd.astrocraft.gui.screens.lander.LanderGuiWindow;
...
import net.mrscauthd.astrocraft.gui.screens.rocket.RocketGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.rover.RoverGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.solarpanel.SolarPanelGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.waterpump.WaterPumpGuiWindow;
import net.mrscauthd.astrocraft.particle.LargeFlameParticle;
import net.mrscauthd.astrocraft.particle.SmokeParticle;
import net.mrscauthd.astrocraft.particle.VenusRainParticle;
import net.mrscauthd.astrocraft.entity.renderer.alien.AlienRenderer;
import org.lwjgl.glfw.GLFW;

@Mod.EventBusSubscriber(modid = AstroCraftMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class ClientEventBusSubscriber {
	...
	public static void onClientSetup(FMLClientSetupEvent event) {
		...
		key1 = new KeyMapping("key." + AstroCraftMod.MODID + ".rocket_start", GLFW.GLFW_KEY_SPACE, "key.categories." + AstroCraftMod.MODID);
