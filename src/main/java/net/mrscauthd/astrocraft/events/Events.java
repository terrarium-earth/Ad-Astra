...
import net.mrscauthd.astrocraft.events.forgeevents.RenderHandItemEvent;
import net.mrscauthd.astrocraft.events.forgeevents.SetupLivingBipedAnimEvent;
...
public class Events {
    ...
    public static void onLivingEntityTick(LivingEvent.LivingUpdateEvent event) {
        ...
        //Venus Rain
        Methodes.VenusRain(entity, new ResourceLocation(AstroCraftMod.MODID, "venus"));

        //Venus Fire
        Methodes.VenusFire(entity, new ResourceLocation(AstroCraftMod.MODID, "venus"), new ResourceLocation(AstroCraftMod.MODID, "mercury"));
    }
    ...
    public static void renderPlayerArm(RenderArmEvent event) {
        ...
        if (event.getArm() == HumanoidArm.RIGHT) {
            if (Methodes.checkArmor(event.getPlayer(), 2, ModInnet.SPACE_SUIT.get())) {
                ...
                Methodes.renderArm(event.getPoseStack(), event.getMultiBufferSource(), event.getPackedLight(), new ResourceLocation(AstroCraftMod.MODID, "textures/models/armor/arm/space_suit.png"), event.getPlayer(), playerModel, playerModel.rightArm);
                event.setCanceled(true);
            } else if (Methodes.checkArmor(event.getPlayer(), 2, ModInnet.NETHERITE_SPACE_SUIT.get())) {

                Methodes.renderArm(event.getPoseStack(), event.getMultiBufferSource(), event.getPackedLight(), new ResourceLocation(AstroCraftMod.MODID, "textures/models/armor/arm/netherite_space_suit.png"), event.getPlayer(), playerModel, playerModel.rightArm);
                event.setCanceled(true);
            }
        }
        ...
        if (event.getArm() == HumanoidArm.LEFT) {
            if (Methodes.checkArmor(event.getPlayer(), 2, ModInnet.SPACE_SUIT.get())) {
                ...
                Methodes.renderArm(event.getPoseStack(), event.getMultiBufferSource(), event.getPackedLight(), new ResourceLocation(AstroCraftMod.MODID, "textures/models/armor/arm/space_suit.png"), event.getPlayer(), playerModel, playerModel.leftArm);
                event.setCanceled(true);
            } else if (Methodes.checkArmor(event.getPlayer(), 2, ModInnet.NETHERITE_SPACE_SUIT.get())) {

                Methodes.renderArm(event.getPoseStack(), event.getMultiBufferSource(), event.getPackedLight(), new ResourceLocation(AstroCraftMod.MODID, "textures/models/armor/arm/netherite_space_suit.png"), event.getPlayer(), playerModel, playerModel.leftArm);
                event.setCanceled(true);
            }
        }
    }
    ...
    public static void onWorldTick(TickEvent.WorldTickEvent event) {
        if (event.phase == TickEvent.Phase.END) {
            ...
            if (world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"moon"))
             || world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"moon_orbit"))
             || world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"mars"))
             || world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"mars_orbit"))
             || world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"mercury"))
             || world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"mercury_orbit"))
             || world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"venus_orbit"))
             || world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"overworld_orbit"))) {
                world.thunderLevel = 0;
                world.rainLevel = 0;
            }
            if (world2 == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(AstroCraftMod.MODID,"venus"))) {
                world.thunderLevel = 0;
            }
        }
    }
