...
import net.mrscauthd.astrocraft.world.structure.*;

import java.util.HashMap;
import java.util.Map;

public class STStructures {
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, AstroCraftMod.MODID);
