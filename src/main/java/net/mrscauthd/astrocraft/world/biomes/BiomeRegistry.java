package net.mrscauthd.astrocraft.world.biomes;
...
public class BiomeRegistry {
    ...
    public static void registerBiomes(RegistryEvent.Register<Biome> event) {
        ...
        if (moon == null) {
            ...
            event.getRegistry().register(moon.setRegistryName(AstroCraftMod.MODID,"moon"));
        }
        ...
        if (mars == null) {
            ...
            event.getRegistry().register(mars.setRegistryName(AstroCraftMod.MODID,"mars"));
        }
        ...
        if (mars_ice_spikes == null) {
            ...
            event.getRegistry().register(mars_ice_spikes.setRegistryName(AstroCraftMod.MODID,"mars_ice_spikes"));
        }
        ...
        if (venus == null) {
            ...
            event.getRegistry().register(venus.setRegistryName(AstroCraftMod.MODID,"venus"));
        }
        ...
        if (infernal_venus_barrens == null) {
            ...
            event.getRegistry().register(infernal_venus_barrens.setRegistryName(AstroCraftMod.MODID,"infernal_venus_barrens"));
        }
        ...
        if (mercury == null) {
            ...
            event.getRegistry().register(mercury.setRegistryName(AstroCraftMod.MODID,"mercury"));
        }
        ...
        if (orbit == null) {
            ...
            event.getRegistry().register(orbit.setRegistryName(AstroCraftMod.MODID,"orbit"));
        }
    }
