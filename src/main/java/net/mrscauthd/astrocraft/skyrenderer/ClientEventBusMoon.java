...
public class ClientEventBusMoon {
    ...
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(AstroCraftMod.MODID, "moon");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation SUN_TEXTURES = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/no_a_sun.png");
    private static final ResourceLocation EARTH = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/earth.png");
    private static final ResourceLocation EARTH_LIGHT_TEXTURES = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/earth_light.png");
