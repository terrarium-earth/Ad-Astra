...
public class ClientEventBusVenusOrbit {
    ...
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(AstroCraftMod.MODID, "venus_orbit");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation VENUS_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/venus.png");
