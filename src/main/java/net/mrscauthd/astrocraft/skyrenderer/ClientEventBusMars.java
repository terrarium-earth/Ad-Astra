...
public class ClientEventBusMars {
	...
	private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(AstroCraftMod.MODID, "mars");

	private static final ResourceLocation SUN_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/sun.png");
	private static final ResourceLocation PHOBOS_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/phobos.png");
	private static final ResourceLocation DEIMOS_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/deimos.png");
