...
public class ClientEventBusMoonOrbit {
    ...
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(AstroCraftMod.MODID, "moon_orbit");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation MOON_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/moon.png");
