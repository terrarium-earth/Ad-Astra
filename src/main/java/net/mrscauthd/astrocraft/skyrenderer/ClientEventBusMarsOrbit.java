...
public class ClientEventBusMarsOrbit {
    ...
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(AstroCraftMod.MODID, "mars_orbit");

    @Nullable
    public static VertexBuffer starBuffer;
	private static final ResourceLocation MARS_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/mars.png");
