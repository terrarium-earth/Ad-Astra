...
public class ClientEventBusMercuryOrbit {
    ...
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(AstroCraftMod.MODID, "mercury_orbit");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation MERCURY_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/mercury.png");
    private static final ResourceLocation SUN_TEXTURE = new ResourceLocation(AstroCraftMod.MODID, "textures/sky/no_a_sun.png");
