package net.mrscauthd.astrocraft.gui.screens.fuelrefinery;
...
public class FuelRefineryGuiWindow extends AbstractContainerScreen<FuelRefineryGui.GuiContainer> {
	...
	public static final ResourceLocation texture = new ResourceLocation(AstroCraftMod.MODID, "textures/screens/fuel_refinery_gui.png");
