package net.mrscauthd.astrocraft.gui.screens.oxygenbubbledistributor;
...
public class OxygenBubbleDistributorGuiWindow extends AbstractContainerScreen<OxygenBubbleDistributorGui.GuiContainer> {
	...
	public static final ResourceLocation texture = new ResourceLocation(AstroCraftMod.MODID, "textures/screens/oxygen_bubble_distributor_gui.png");
	...
	private static ResourceLocation HideButton = new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button.png");
	private static ResourceLocation Button1 = new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button_plus.png");
	private static ResourceLocation Button2 = new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button_minus.png");
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (GuiHelper.isHover(this.getButtonBounds(-20, 4, 20, 21), mouseX, mouseY)) {
			button_plus.setTexture(new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button_plus_2.png"));
		} else {
			button_plus.setTexture(new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button_plus.png"));
		}

		if (GuiHelper.isHover(this.getButtonBounds(-20, 25, 20, 20), mouseX, mouseY)) {
			button_minus.setTexture(new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button_minus_2.png"));
		} else {
			button_minus.setTexture(new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button_minus.png"));
		}

		if (GuiHelper.isHover(this.getButtonBounds(-20, -22, 34, 20), mouseX, mouseY)) {
			workingAreaVisibleButton.setTexture(new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button_2.png"));
		} else {
			workingAreaVisibleButton.setTexture(new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/technik_button.png"));
		}
	}
	...
	protected void init() {
		...
		button_plus = this.addRenderableWidget(new ImageButtonPlacer(this.leftPos - 20, this.topPos + 5, 20, 20, 0, 0, 0, Button1, 20, 20, (p_2130901) -> {
			...
			AstroCraftMod.PACKET_HANDLER.sendToServer(new OxygenBubbleDistributorBlockEntity.ChangeRangeMessage(pos, true));
		}));
		...
		button_minus = this.addRenderableWidget(new ImageButtonPlacer(this.leftPos - 20, this.topPos + 25, 20, 20, 0, 0, 0, Button2, 20, 20, (p_2130901) -> {
			BlockPos pos = this.getMenu().getBlockEntity().getBlockPos();
			AstroCraftMod.PACKET_HANDLER.sendToServer(new OxygenBubbleDistributorBlockEntity.ChangeRangeMessage(pos, false));
		}));
		...
		workingAreaVisibleButton = this.addRenderableWidget(new ImageButtonPlacer(this.leftPos - 20, this.topPos - 22, 34, 20, 0, 0, 0, HideButton, 34, 20, e -> {
			BlockPos pos = this.getMenu().getBlockEntity().getBlockPos();
			AstroCraftMod.PACKET_HANDLER.sendToServer(new OxygenBubbleDistributorBlockEntity.ChangeWorkingAreaVisibleMessage(pos, !this.cachedWorkingAreaVisible));
		}));
	}
	...
	protected void renderLabels(PoseStack ms, int mouseX, int mouseY) {
		...
		TranslatableComponent workingAreaText = new TranslatableComponent("gui." + AstroCraftMod.MODID + ".oxygen_bubble_distributor.workingarea.text", rangeToString, rangeToString, rangeToString);
		...
		if ((range * 2) + 1 > 9) {
			RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/oxygen_range_layer.png"));
			GuiComponent.blit(ms, workingAreaOffsetX + 1, workingAreaTop, 0, 0, 150, 25, 150, 25);
			textwidth = 13;
		} else {
			RenderSystem.setShaderTexture(0, new ResourceLocation(AstroCraftMod.MODID, "textures/buttons/oxygen_range_small_layer.png"));
		...
		String prefix = "gui." + AstroCraftMod.MODID + ".oxygen_bubble_distributor.workingarea.";
