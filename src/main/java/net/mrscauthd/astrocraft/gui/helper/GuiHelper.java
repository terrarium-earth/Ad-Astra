...
public class GuiHelper {
	...
	public static final ResourceLocation FIRE_PATH = new ResourceLocation(AstroCraftMod.MODID, "textures/fire_on.png");
	public static final int FIRE_WIDTH = 14;
	public static final int FIRE_HEIGHT = 14;
	public static final ResourceLocation ARROW_PATH = new ResourceLocation(AstroCraftMod.MODID, "textures/animated_arrow_full.png");
	public static final int ARROW_WIDTH = 24;
	public static final int ARROW_HEIGHT = 17;
	public static final ResourceLocation OXYGEN_CONTENT_PATH = new ResourceLocation(AstroCraftMod.MODID, "textures/oxygen.png");
	public static final ResourceLocation OXYGEN_TANK_PATH = new ResourceLocation(AstroCraftMod.MODID, "textures/fluid_tank_fore.png");
	public static final int OXYGEN_TANK_WIDTH = 14;
	public static final int OXYGEN_TANK_HEIGHT = 48;
	public static final ResourceLocation ENERGY_PATH = new ResourceLocation(AstroCraftMod.MODID, "textures/energy_full.png");
	...
	public static final ResourceLocation FLUID_TANK_PATH = new ResourceLocation(AstroCraftMod.MODID, "textures/fluid_tank_fore.png");
	...
	public static void drawFuel(PoseStack matrixStack, int left, int top, double ratio) {
		ResourceLocation full = new ResourceLocation(AstroCraftMod.MODID, "textures/rocket_fuel_bar_full.png");
