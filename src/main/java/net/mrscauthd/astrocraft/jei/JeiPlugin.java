package net.mrscauthd.astrocraft.jei;
...
import net.mrscauthd.astrocraft.crafting.OxygenBubbleDistributorRecipe;
import net.mrscauthd.astrocraft.crafting.OxygenLoaderRecipe;
import net.mrscauthd.astrocraft.crafting.RocketPart;
import net.mrscauthd.astrocraft.crafting.WorkbenchingRecipe;
...
import net.mrscauthd.astrocraft.gui.helper.GridPlacer;
import net.mrscauthd.astrocraft.gui.helper.GuiHelper;
import net.mrscauthd.astrocraft.gui.helper.IPlacer;
import net.mrscauthd.astrocraft.gui.helper.RocketPartGridPlacer;
...
import net.mrscauthd.astrocraft.gui.screens.coalgenerator.CoalGeneratorGui;
import net.mrscauthd.astrocraft.gui.screens.coalgenerator.CoalGeneratorGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.compressor.CompressorGui;
import net.mrscauthd.astrocraft.gui.screens.compressor.CompressorGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.fuelrefinery.FuelRefineryGui;
import net.mrscauthd.astrocraft.gui.screens.fuelrefinery.FuelRefineryGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.nasaworkbench.NasaWorkbenchGui;
import net.mrscauthd.astrocraft.gui.screens.nasaworkbench.NasaWorkbenchGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.oxygenbubbledistributor.OxygenBubbleDistributorGui;
import net.mrscauthd.astrocraft.gui.screens.oxygenbubbledistributor.OxygenBubbleDistributorGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.oxygenloader.OxygenLoaderGui;
import net.mrscauthd.astrocraft.gui.screens.oxygenloader.OxygenLoaderGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.planetselection.PlanetSelectionGuiWindow;
import net.mrscauthd.astrocraft.gui.screens.rocket.RocketGui;
import net.mrscauthd.astrocraft.jei.jeiguihandlers.BlastFurnaceGuiContainerHandler;
import net.mrscauthd.astrocraft.jei.jeiguihandlers.CoalGeneratorGuiContainerHandler;
import net.mrscauthd.astrocraft.jei.jeiguihandlers.CompressorGuiContainerHandler;
import net.mrscauthd.astrocraft.jei.jeiguihandlers.PlanetSlecetionGuiJeiHandler;
...
import net.mrscauthd.astrocraft.machines.tile.FuelRefineryBlockEntity;
...
import net.mrscauthd.astrocraft.machines.tile.OxygenMakingBlockEntity;
...
public class JeiPlugin implements IModPlugin {
	...
	public ResourceLocation getPluginUid() {
		return new ResourceLocation(AstroCraftMod.MODID, "default");
	}
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		// Oil
		Component oilDescriptionKey = new TranslatableComponent("jei.tooltip." + AstroCraftMod.MODID + ".oil");
	...
	private List<OxygenLoaderRecipe> generateOxygenLoaderRecipes() {
		return AstroCraftRecipeTypes.OXYGENLOADER.getRecipes(this.getLevel());
	}

	// Oxygen Bubble Distributor
	private List<OxygenBubbleDistributorRecipe> generateOxygenBubbleDistributorRecipes() {
		return AstroCraftRecipeTypes.OXYGENBUBBLEDISTRIBUTOR.getRecipes(this.getLevel());
	}

	// Generator
	private List<GeneratingRecipe> generateGeneratorRecipes() {
		return AstroCraftRecipeTypes.GENERATING.getRecipes(this.getLevel());
	}

	// Workbench
	private List<WorkbenchingRecipe> generateWorkbenchRecipes() {
		return AstroCraftRecipeTypes.WORKBENCHING.getRecipes(this.getLevel());
	}

	// BlastFurnace
	private List<BlastingRecipe> generateBlastingFurnaceRecipes() {
		return AstroCraftRecipeTypes.BLASTING.getRecipes(this.getLevel());
	}

	// Compressor
	private List<CompressingRecipe> generateCompressingRecipes() {
		return AstroCraftRecipeTypes.COMPRESSING.getRecipes(this.getLevel());
	}
	...
	private List<FuelRefiningRecipe> generateFuelMakerRecipes() {
		return AstroCraftRecipeTypes.FUELREFINING.getRecipes(this.getLevel());
	}
	...
	public static class OxygenLoaderJeiCategory implements IRecipeCategory<OxygenLoaderRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "oxygen_loader");
		...
		public OxygenLoaderJeiCategory(JeiPlugin plugin, IGuiHelper guiHelper) {
			this.plugin = plugin;
			this.title = new TranslatableComponent("container." + AstroCraftMod.MODID + ".oxygen_loader");
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/oxygen_loader_jei.png"), 0, 0, 148, 64);
	...
	public static class OxygenBubbleDistributorJeiCategory implements IRecipeCategory<OxygenBubbleDistributorRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "oxygen_bubble_distributor");
		public static final int INPUT_TANK_LEFT = 8;
		public static final int INPUT_TANK_TOP = 8;
		public static final int OUTPUT_TANK_LEFT = 74;
		public static final int OUTPUT_TANK_TOP = 8;
		...
		public OxygenBubbleDistributorJeiCategory(JeiPlugin plugin, IGuiHelper guiHelper) {
			this.plugin = plugin;
			this.title = new TranslatableComponent("container." + AstroCraftMod.MODID + ".oxygen_bubble_distributor");
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/oxygen_bubble_distributor_jei.png"), 0, 0, 148, 64);
			this.fluidOverlay = guiHelper.drawableBuilder(GuiHelper.FLUID_TANK_PATH, 0, 0, GuiHelper.FLUID_TANK_WIDTH, GuiHelper.FLUID_TANK_HEIGHT).setTextureSize(GuiHelper.FLUID_TANK_WIDTH, GuiHelper.FLUID_TANK_HEIGHT).build();
			this.cachedEnergies = createUsingEnergies(guiHelper);
		}
	...
	public static class CoalGeneratorJeiCategory implements IRecipeCategory<GeneratingRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "generatorcategory");// muss klein geschrieben sein
		...
		public CoalGeneratorJeiCategory(IGuiHelper guiHelper) {
			this.title = new TranslatableComponent("container." + AstroCraftMod.MODID + ".coal_generator");
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/generator_gui_jei.png"), 0, 0, 144, 84);
	...
	public static class NASAWorkbenchJeiCategory implements IRecipeCategory<WorkbenchingRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "workbenchcategory"); // muss klein sein !
		// ...
		private final Component title;
		private final IDrawable background;

		public NASAWorkbenchJeiCategory(IGuiHelper guiHelper) {
			this.title = new TranslatableComponent("container." + AstroCraftMod.MODID + ".nasa_workbench");
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/nasaworkbenchjei.png"), 0, 0, 176, 122);
		}
	...
	public static class BlastingFurnaceJeiCategory implements IRecipeCategory<BlastingRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "blastingfurnacecategory");
		...
		public BlastingFurnaceJeiCategory(IGuiHelper guiHelper) {
			this.title = new TranslatableComponent("container." + AstroCraftMod.MODID + ".blast_furnace");
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/blast_furnace_gui_jei.png"), 0, 0, 144, 84);
	...
	public static class Tier1RocketJeiCategory implements IRecipeCategory<FuelLoadingRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "rocket_t_1_category");
		...
		public Tier1RocketJeiCategory(IGuiHelper guiHelper) {
			...
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/rocket_gui_jei.png"), 0, 0, 128, 71);
		}
	...
	public static class Tier2RocketJeiCategory implements IRecipeCategory<FuelLoadingRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "rocket_t_2_category");
	...
	public static class Tier3RocketJeiCategory implements IRecipeCategory<FuelLoadingRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "rocket_t_3_category");
	...
	public static class CompressorJeiCategory implements IRecipeCategory<CompressingRecipe> {
		...
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "compressorcategory");
		...
		public CompressorJeiCategory(IGuiHelper guiHelper) {
			this.title = new TranslatableComponent("container." + AstroCraftMod.MODID + ".compressor");
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/compressor_gui_jei.png"), 0, 0, 144, 84);
			this.cachedArrows = createArrows(guiHelper);
			this.cachedEnergies = createUsingEnergies(guiHelper);
		}
	...
	public static class FuelRefineryJeiCategory implements IRecipeCategory<FuelRefiningRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "fuelmakercategory");
		public static final int INPUT_TANK_LEFT = 8;
		public static final int INPUT_TANK_TOP = 8;
		public static final int OUTPUT_TANK_LEFT = 74;
		public static final int OUTPUT_TANK_TOP = 8;
		...
		public FuelRefineryJeiCategory(JeiPlugin plugin, IGuiHelper guiHelper) {
			this.plugin = plugin;
			this.title = new TranslatableComponent("container." + AstroCraftMod.MODID + ".fuel_refinery");
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/fuel_refinery_jei.png"), 0, 0, 148, 64);
			this.fluidOverlay = guiHelper.drawableBuilder(GuiHelper.FLUID_TANK_PATH, 0, 0, GuiHelper.FLUID_TANK_WIDTH, GuiHelper.FLUID_TANK_HEIGHT).setTextureSize(GuiHelper.FLUID_TANK_WIDTH, GuiHelper.FLUID_TANK_HEIGHT).build();
			this.cachedEnergies = createUsingEnergies(guiHelper);
		}
	...
	public static class RoverJeiCategory implements IRecipeCategory<FuelLoadingRecipe> {
		public static final ResourceLocation Uid = new ResourceLocation(AstroCraftMod.MODID, "rovercategory");
		...
		public RoverJeiCategory(IGuiHelper guiHelper) {
			...
			this.background = guiHelper.createDrawable(new ResourceLocation(AstroCraftMod.MODID, "textures/jei/rover_jei.png"), 0, 0, 144, 84);
			this.fluidOverlay = guiHelper.drawableBuilder(GuiHelper.FLUID_TANK_PATH, 0, 0, GuiHelper.FLUID_TANK_WIDTH, GuiHelper.FLUID_TANK_HEIGHT).setTextureSize(GuiHelper.FLUID_TANK_WIDTH, GuiHelper.FLUID_TANK_HEIGHT).build();
		}
