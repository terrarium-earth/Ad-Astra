...
public class AlienRenderer extends MobRenderer<AlienEntity, AlienModel<AlienEntity>> {
    ...
    public ResourceLocation getTextureLocation(AlienEntity entity) {
        if (entity.getVillagerData().getProfession() == VillagerProfession.FARMER) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien1.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.FISHERMAN) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien2.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.SHEPHERD) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien3.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.FLETCHER) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien4.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.LIBRARIAN) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien5.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.CARTOGRAPHER) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien6.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.CLERIC) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien7.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.ARMORER) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien8.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.WEAPONSMITH) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien9.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.TOOLSMITH) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien10.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.BUTCHER) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien11.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.LEATHERWORKER) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien12.png");
        }
        if (entity.getVillagerData().getProfession() == VillagerProfession.MASON) {
            return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien13.png");
        }

        return new ResourceLocation(AstroCraftMod.MODID,"textures/entities/alien/entity_alien.png");
    }
}