package net.mrscauthd.astrocraft.entity.renderer.spacesuit;
...
public class SpaceSuitModel {
    public static class SPACE_SUIT_P1<T extends LivingEntity> extends EntityModel<T> {
        ...
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AstroCraftMod.MODID, "space_suit_p1"), "main");
    ...
    public static class SPACE_SUIT_P2<T extends Entity> extends EntityModel<T> {
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AstroCraftMod.MODID, "space_suit_p2"), "main");
