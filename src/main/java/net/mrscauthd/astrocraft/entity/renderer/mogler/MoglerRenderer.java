package net.mrscauthd.astrocraft.entity.renderer.mogler;
...
import net.mrscauthd.astrocraft.entity.MoglerEntity;

@OnlyIn(Dist.CLIENT)
public class MoglerRenderer extends MobRenderer<MoglerEntity, MoglerModel<MoglerEntity>> {
    private static final ResourceLocation HOGLIN_LOCATION = new ResourceLocation(AstroCraftMod.MODID,"textures/entities/mogler_entity.png");
