package net.mrscauthd.astrocraft.entity.renderer.pygro;
...
public class PygroModel<T extends Mob> extends PlayerModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AstroCraftMod.MODID, "pygro"), "main");
