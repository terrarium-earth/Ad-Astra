package net.mrscauthd.astrocraft.entity.renderer.flag;
...
public class TileEntityHeadModel extends SkullModelBase {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AstroCraftMod.MODID, "flag"), "main");
