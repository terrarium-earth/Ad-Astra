...
public class GaugeTextHelper {
	...
	public static final ResourceLocation USING_NAME = new ResourceLocation(AstroCraftMod.MODID, "using");
	public static final ResourceLocation USING2_NAME = new ResourceLocation(AstroCraftMod.MODID, "using2");
	public static final ResourceLocation GENERATING_NAME = new ResourceLocation(AstroCraftMod.MODID, "generating");
	public static final ResourceLocation MAXGENERATION_NAME = new ResourceLocation(AstroCraftMod.MODID, "maxgeneration");
	public static final ResourceLocation TOTAL_NAME = new ResourceLocation(AstroCraftMod.MODID, "total");
	public static final ResourceLocation STORED_NAME = new ResourceLocation(AstroCraftMod.MODID, "stored");
	public static final ResourceLocation CAPACITY_NAME = new ResourceLocation(AstroCraftMod.MODID, "capacity");
	public static final ResourceLocation TRANSFER_NAME = new ResourceLocation(AstroCraftMod.MODID, "transfer");
