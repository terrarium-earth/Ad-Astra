...
import net.mrscauthd.astrocraft.machines.tile.PowerSystemFuelBurnTime;

public class GaugeValueHelper {

	public static final ResourceLocation ENERGY_NAME = new ResourceLocation(AstroCraftMod.MODID, "energy");
	public static final ResourceLocation OXYGEN_NAME = new ResourceLocation(AstroCraftMod.MODID, "oxygen");
	public static final ResourceLocation FLUID_NAME = new ResourceLocation(AstroCraftMod.MODID, "fluid");
	public static final ResourceLocation FUEL_NAME = new ResourceLocation(AstroCraftMod.MODID, "fuel");
	public static final ResourceLocation BURNTIME_NAME = new ResourceLocation(AstroCraftMod.MODID, "burntime");
	public static final ResourceLocation COOKTIME_NAME = new ResourceLocation(AstroCraftMod.MODID, "cooktime");
