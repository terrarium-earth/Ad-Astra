...
public class GaugeValueSerializer<T extends INBTSerializable<CompoundTag>> {
	...
	static {
		Serializer.addCodec(new ResourceLocation(AstroCraftMod.MODID, "fluidstack"), GaugeValueFluidStack.class);
		Serializer.addCodec(new ResourceLocation(AstroCraftMod.MODID, "simple"), GaugeValueSimple.class);
	}
