...
public class LunarianWanderingTraderEntityModel extends VillagerResemblingModel<LunarianWanderingTraderEntity> {
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new ModIdentifier("lunarian_wandering_trader"), "main");

        public LunarianWanderingTraderEntityModel(ModelPart root) {
                super(root);
        }
        ...
        public static TexturedModelData getTexturedModelData() {
                ...
                ModelPartData head = modelPartData.addChild("head",
                                ModelPartBuilder.create().uv(0, 0).mirrored().cuboid(-4.0f, -9.0f, -4.0f, 8.0f, 9.0f, 8.0f, new Dilation(0.0f)).mirrored(false).uv(32, 0).mirrored().cuboid(-4.5f, -18.0f, -4.5f, 9.0f, 10.0f, 9.0f, new Dilation(0.0f))
                                                .mirrored(false).uv(96, 0).mirrored().cuboid(-4.0f, -9.0f, -4.0f, 8.0f, 9.0f, 8.0f, new Dilation(0.5f)).mirrored(false).uv(24, 0).mirrored().cuboid(-1.0f, -3.0f, -6.0f, 2.0f, 4.0f, 2.0f, new Dilation(0.0f))
                                                .mirrored(false),
                ...
                ModelPartData body = modelPartData.addChild(
                                "body", ModelPartBuilder.create().uv(16, 20).mirrored().cuboid(0.0f, -12.0f, -5.0f, 8.0f, 12.0f, 6.0f, new Dilation(0.0f)).mirrored(false).uv(0, 38).mirrored()
                                                .cuboid(0.0f, -12.0f, -5.0f, 8.0f, 18.0f, 6.0f, new Dilation(0.5f)).mirrored(false).uv(0, 62).mirrored().cuboid(0.0f, -12.0f, -5.0f, 8.0f, 18.0f, 6.0f, new Dilation(0.7f)).mirrored(false),
