...
public class RocketEntityModelTier1 extends VehicleEntityModel<RocketEntityTier1> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData top = rocket.addChild("top", ModelPartBuilder.create().uv(0, 48).cuboid(10.0f, -52.0f, -10.0f, 0.0f, 2.0f, 20.0f, new Dilation(0.0f)).uv(0, 68).cuboid(-10.0f, -52.0f, -10.0f, 20.0f, 2.0f, 0.0f, new Dilation(0.0f)).uv(0, 48)
                .cuboid(-10.0f, -52.0f, -10.0f, 0.0f, 2.0f, 20.0f, new Dilation(0.0f)).uv(0, 68).cuboid(-10.0f, -52.0f, 10.0f, 20.0f, 2.0f, 0.0f, new Dilation(0.0f)).uv(104, 67).cuboid(-3.0f, -75.0f, -3.0f, 6.0f, 8.0f, 6.0f, new Dilation(0.0f)).uv(88, 69)
                .cuboid(-2.0f, -77.0f, -2.0f, 4.0f, 2.0f, 4.0f, new Dilation(0.0f)).uv(80, 69).cuboid(-1.0f, -89.0f, -1.0f, 2.0f, 13.0f, 2.0f, new Dilation(0.0f)).uv(64, 69).cuboid(-2.0f, -90.0f, -2.0f, 4.0f, 4.0f, 4.0f, new Dilation(0.0f)),
        ...
        ModelPartData body = rocket.addChild("body", ModelPartBuilder.create().uv(36, 44).cuboid(-6.0f, -42.0f, -10.0f, 12.0f, 12.0f, 1.0f, new Dilation(0.0f)).uv(35, 58).cuboid(-4.0f, -32.0f, -10.0f, 8.0f, 0.0f, 1.0f, new Dilation(0.0f)).uv(63, 43)
                .cuboid(4.0f, -40.0f, -10.0f, 0.0f, 8.0f, 1.0f, new Dilation(0.0f)).uv(35, 58).cuboid(-4.0f, -40.0f, -10.0f, 8.0f, 0.0f, 1.0f, new Dilation(0.0f)).uv(63, 43).cuboid(-4.0f, -40.0f, -10.0f, 0.0f, 8.0f, 1.0f, new Dilation(0.0f)).uv(0, 0)
                .cuboid(-9.0f, -51.0f, -9.0f, 18.0f, 44.0f, 0.0f, new Dilation(0.0f)).uv(0, 77).cuboid(-9.0f, -51.0f, -9.0f, 2.0f, 44.0f, 2.0f, new Dilation(0.0f)).uv(36, -18).cuboid(-9.0f, -51.0f, -9.0f, 0.0f, 44.0f, 18.0f, new Dilation(0.0f)).uv(36, 0)
                .cuboid(-9.0f, -51.0f, 9.0f, 18.0f, 44.0f, 0.0f, new Dilation(0.0f)).uv(36, -18).cuboid(9.0f, -51.0f, -9.0f, 0.0f, 44.0f, 18.0f, new Dilation(0.0f)).uv(0, 62).cuboid(-10.0f, -15.0f, -10.0f, 20.0f, 5.0f, 0.0f, new Dilation(0.0f)).uv(0, 42)
                .cuboid(10.0f, -15.0f, -10.0f, 0.0f, 5.0f, 20.0f, new Dilation(0.0f)).uv(0, 62).cuboid(-10.0f, -15.0f, 10.0f, 20.0f, 5.0f, 0.0f, new Dilation(0.0f)).uv(0, 42).cuboid(-10.0f, -15.0f, -10.0f, 0.0f, 5.0f, 20.0f, new Dilation(0.0f)).uv(-18, 44)
                .cuboid(-9.0f, -7.0f, -9.0f, 18.0f, 0.0f, 18.0f, new Dilation(0.0f)).uv(-18, 44).cuboid(-9.0f, -50.0f, -9.0f, 18.0f, 0.0f, 18.0f, new Dilation(0.0f)).uv(88, 0).cuboid(-13.0f, -17.0f, -3.0f, 4.0f, 9.0f, 6.0f, new Dilation(0.0f)).uv(0, 71)
                .cuboid(-12.0f, -20.0f, -1.0f, 3.0f, 3.0f, 2.0f, new Dilation(0.0f)), ModelTransform.pivot(0.0f, -1.0f, 0.0f));
        ...
        ModelPartData bottom = body.addChild("bottom",
                ModelPartBuilder.create().uv(94, 15).cuboid(-8.0f, -4.0f, -8.0f, 16.0f, 4.0f, 0.0f, new Dilation(0.0f)).uv(94, -1).cuboid(-8.0f, -4.0f, -8.0f, 0.0f, 4.0f, 16.0f, new Dilation(0.0f)).uv(94, 15)
