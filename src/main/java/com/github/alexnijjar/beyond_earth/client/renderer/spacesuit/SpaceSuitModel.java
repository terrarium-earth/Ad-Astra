...
public class SpaceSuitModel {
        ...
        public static class SPACE_SUIT_P1<T extends LivingEntity> extends BipedEntityModel<T> {
                ...
                public SPACE_SUIT_P1(ModelPart root) {
                        super(new EntityRendererFactory.Context(MINECRAFT_CLIENT.getEntityRenderDispatcher(), MINECRAFT_CLIENT.getItemRenderer(), MINECRAFT_CLIENT.getResourceManager(), MINECRAFT_CLIENT.getEntityModelLoader(), MINECRAFT_CLIENT.textRenderer)
                                        .getPart(EntityModelLayers.PLAYER_INNER_ARMOR));
