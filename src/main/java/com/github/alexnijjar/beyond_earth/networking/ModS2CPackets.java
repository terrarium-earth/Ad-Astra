...
public class ModS2CPackets {
    ...
    public static final Identifier START_ROCKET_PACKET_ID = new ModIdentifier("start_rocket_packet");
    ...
    public static void register() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(START_ROCKET_PACKET_ID, (client, handler, buf, responseSender) -> {
            int id = buf.readInt();
