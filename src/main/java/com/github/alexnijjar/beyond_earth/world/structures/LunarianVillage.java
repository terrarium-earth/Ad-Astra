...
public class LunarianVillage extends StructureFeature<StructurePoolFeatureConfig> {

    public LunarianVillage() {
        super(JigsawConfigurator.CODEC, LunarianVillage::generate, PostPlacementProcessor.EMPTY);
    }
    ...
    private static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> generate(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!LunarianVillage.isFeatureChunk(context)) {
