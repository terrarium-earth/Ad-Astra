...
public class SimpleStructure extends StructureFeature<StructurePoolFeatureConfig> {
    ...
    public SimpleStructure(Codec<StructurePoolFeatureConfig> codec) {
        super(codec, SimpleStructure::generate, PostPlacementProcessor.EMPTY);
    }
    ...
    private static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> generate(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!SimpleStructure.isFeatureChunk(context)) {
