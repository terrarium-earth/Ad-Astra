...
public class EmiGeneratingRecipe implements EmiRecipe {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        EmiTextures.createEnergyWidget(widgets, 100 + xOffset, -20 + yOffset, (int) BeyondEarth.CONFIG.coalGenerator.energyPerTick, true);

        OrderedText ratioText = EmiPort.ordered(EmiPort.translatable("rei.text.beyond_earth.generates", this.recipe.getCookTime() * BeyondEarth.CONFIG.coalGenerator.energyPerTick));
