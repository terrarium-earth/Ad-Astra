...
public class BeyondEarthClientPlugin implements REIClientPlugin {
    ...
    public void registerDisplays(DisplayRegistry registry) {
        ...
        DefaultInformationDisplay info = DefaultInformationDisplay.createFromEntry(EntryStacks.of(ModItems.OIL_BUCKET), new TranslatableText("rei.text.beyond_earth.oil.title"));
        info.lines(new TranslatableText("rei.text.beyond_earth.oil.body"));
        registry.add(info);
    }
}
