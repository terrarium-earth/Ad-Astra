...
public class FuelConversionCategory implements DisplayCategory<FuelConversionDisplay> {
    ...
    public List<Widget> setupDisplay(FuelConversionDisplay display, Rectangle bounds) {
        ...
        widgets.add(widget);
        widgets.add(Widgets.withTooltip(Widgets.withBounds(widget, bounds), new TranslatableText("rei.tooltip.beyond_earth.energy_using", BeyondEarth.CONFIG.fuelRefinery.energyPerTick)));
