...
public class SpaceStationCategory implements DisplayCategory<SpaceStationDisplay> {
    ...
    public static final Identifier ICON = new ModIdentifier("textures/screens/rei/space_station_icon.png");
    ...
    public Text getTitle() {
        return new TranslatableText("rei.category.beyond_earth.space_station");
    }
