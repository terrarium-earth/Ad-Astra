...
public class CompressorCategory implements DisplayCategory<CompressorDisplay> {
    ...
    public List<Widget> setupDisplay(CompressorDisplay display, Rectangle bounds) {
        ...
        widgets.add(widget);
        widgets.add(Widgets.withTooltip(Widgets.withBounds(widget, bounds), new TranslatableText("rei.tooltip.beyond_earth.energy_using", CompressorBlockEntity.ENERGY_PER_TICK)));
