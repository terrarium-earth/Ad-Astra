...
import com.github.alexnijjar.ad_astra.client.screens.GuiUtil.FloatDrawableHelper;
...
public class PlayerOverlayScreen {
    ...
    private static final Identifier OXYGEN_TANK_EMPTY_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/overlay/oxygen_tank_empty.png");
    private static final Identifier OXYGEN_TANK_FULL_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/overlay/oxygen_tank_full.png");

    // Planet bar textures.
    private static final Identifier EARTH_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/earth_planet_bar.png");
    private static final Identifier MOON_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/moon_planet_bar.png");
    private static final Identifier MARS_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/mars_planet_bar.png");
    private static final Identifier VENUS_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/venus_planet_bar.png");
    private static final Identifier MERCURY_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/mercury_planet_bar.png");

    private static final Identifier GLACIO_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/glacio_planet_bar.png");

    private static final Identifier ORBIT_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/orbit_planet_bar.png");

    private static final Identifier ROCKET_PLANET_BAR_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/planet_bar/rocket.png");

    private static final Text WARNING_TEXT = new TranslatableText("gui.ad_astra.text.warning");

    private static final Identifier BATTERY_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/overlay/battery.png");
    private static final Identifier BATTERY_EMPTY_TEXTURE = new Identifier(AdAstra.MOD_ID, "textures/gui/overlay/battery_empty.png");
    ...
    public static void render(MatrixStack matrices, float delta) {
        ...
        if (shouldRenderOxygen && !client.options.debugEnabled) {
            ...
            if (doesNotNeedOxygen) {
                client.textRenderer.drawWithShadow(matrices, text, (x + (textureWidth - textWidth) / 2f), y + textureHeight + 3, 0x7FFF00);
            } else {
                client.textRenderer.drawWithShadow(matrices, text, (x + (textureWidth - textWidth) / 2f), y + textureHeight + 3, oxygen <= 0.0f ? 0xDC143C : 0xFFFFFF);
            }
        }
        ...
        if (countdownSeconds > 0) {
            matrices.push();
            matrices.translate(screenWidth / 2.0f, screenHeight / 2.0f, 0.0);
            RenderSystem.enableBlend();
            RenderSystem.defaultBlendFunc();
            matrices.push();
            matrices.scale(4.0F, 4.0F, 4.0F);
            var m = client.textRenderer.getWidth(countdownSeconds + "");
            client.textRenderer.drawWithShadow(matrices, countdownSeconds + "", (float) (-m / 2), -10.0F, 0xe53253);
            matrices.pop();
        ...
        if (shouldRenderBar && !client.options.debugEnabled) {
            ...
            FloatDrawableHelper.drawTexture(matrices, 4.0f, (screenHeight / 2) + (103 / 2) - rocketHeight, 0, 0, 8, 11, 8, 11);
        }
        ...
        if (shouldRenderWarning) {
            ...
            matrices.push();
            matrices.translate(screenWidth / 2.0f, screenHeight / 2.0f / 1.5f, 0.0);
            RenderSystem.enableBlend();
            RenderSystem.defaultBlendFunc();
            matrices.push();
            matrices.scale(4.0F, 4.0F, 4.0F);
            var m = client.textRenderer.getWidth(WARNING_TEXT);
            client.textRenderer.drawWithShadow(matrices, WARNING_TEXT, (float) (-m / 2), -10.0F, BackgroundHelper.ColorMixer.getArgb((int) (sine * 255), (int) (sine * 255), (int) (sine * 255), (int) (sine * 255)));
            matrices.pop();
            RenderSystem.disableBlend();
            matrices.pop();
        }
