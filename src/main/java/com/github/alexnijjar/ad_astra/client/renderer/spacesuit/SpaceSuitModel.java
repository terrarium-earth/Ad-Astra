...
public class SpaceSuitModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData right_boot = modelPartData.addChild("right_boot", ModelPartBuilder.create().uv(32, 32).cuboid(-2.0f, 6.6667f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(1.0f))
		.uv(0, 45).cuboid(-2.0f, 6.6667f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(0.6f)), ModelTransform.pivot(-2.0f, 11.3333f, 0.0f));

		ModelPartData left_boot = modelPartData.addChild("left_boot", ModelPartBuilder.create().uv(48, 32).cuboid(-2.0f, 6.6667f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(1.0f))
		.uv(16, 45).cuboid(-2.0f, 6.6667f, -2.0f, 4.0f, 6.0f, 4.0f, new Dilation(0.6f)), ModelTransform.pivot(2.0f, 11.3333f, 0.0f));
