package com.github.alexnijjar.ad_astra.client.renderer.entity.vehicles.rockets.tier_4;
...
public class RocketEntityModelTier4 extends VehicleEntityModel<RocketEntityTier4> {
        ...
        public static TexturedModelData getTexturedModelData() {
                ...
                ModelPartData rocket = modelPartData.addChild("rocket",
                                ModelPartBuilder.create().uv(88, 80).cuboid(10.0f, -28.0f, -10.0f, 0.0f, 8.0f, 20.0f, new Dilation(0.0f)).uv(88, 100).cuboid(-10.0f, -28.0f, 10.0f, 20.0f, 8.0f, 0.0f, new Dilation(0.0f)).uv(88, 80)
                                                .cuboid(-10.0f, -28.0f, -10.0f, 0.0f, 8.0f, 20.0f, new Dilation(0.0f)).uv(88, 100).cuboid(-10.0f, -28.0f, -10.0f, 20.0f, 8.0f, 0.0f, new Dilation(0.0f)).uv(88, 115)
                                                .cuboid(-10.0f, -38.0f, -10.0f, 20.0f, 7.0f, 0.0f, new Dilation(0.0f)).uv(88, 95).cuboid(10.0f, -38.0f, -10.0f, 0.0f, 7.0f, 20.0f, new Dilation(0.0f)).uv(88, 115)
                                                .cuboid(-10.0f, -38.0f, 10.0f, 20.0f, 7.0f, 0.0f, new Dilation(0.0f)).uv(88, 95).cuboid(-10.0f, -38.0f, -10.0f, 0.0f, 7.0f, 20.0f, new Dilation(0.0f)).uv(88, 108)
                                                .cuboid(-10.0f, -63.0f, -10.0f, 20.0f, 7.0f, 0.0f, new Dilation(0.0f)).uv(88, 88).cuboid(10.0f, -63.0f, -10.0f, 0.0f, 7.0f, 20.0f, new Dilation(0.0f)).uv(88, 108)
                                                .cuboid(-10.0f, -63.0f, 10.0f, 20.0f, 7.0f, 0.0f, new Dilation(0.0f)).uv(88, 88).cuboid(-10.0f, -63.0f, -10.0f, 0.0f, 7.0f, 20.0f, new Dilation(0.0f)),
                                ModelTransform.pivot(0.0f, 24.0f, 0.0f));

                ModelPartData side_booster_right = rocket.addChild("side_booster_right",
                                ModelPartBuilder.create().uv(104, 16).cuboid(-18.0f, -56.0f, -3.0f, 6.0f, 6.0f, 6.0f, new Dilation(0.0f)).uv(96, 28).mirrored().cuboid(-19.0f, -50.0f, -4.0f, 8.0f, 35.0f, 8.0f, new Dilation(0.0f)).mirrored(false).uv(16, 115)
                                                .mirrored().cuboid(-19.0f, -13.0f, -4.0f, 8.0f, 5.0f, 8.0f, new Dilation(0.0f)).mirrored(false).uv(72, 30).mirrored().cuboid(-18.0f, -15.0f, -3.0f, 6.0f, 2.0f, 6.0f, new Dilation(0.0f)).mirrored(false),
                                ModelTransform.pivot(-4.0f, 4.0f, 0.0f));

                ModelPartData side_booster_left = rocket.addChild("side_booster_left",
                                ModelPartBuilder.create().uv(104, 16).cuboid(11.0f, -56.0f, -3.0f, 6.0f, 6.0f, 6.0f, new Dilation(0.0f)).uv(96, 28).cuboid(10.0f, -50.0f, -4.0f, 8.0f, 35.0f, 8.0f, new Dilation(0.0f)).uv(72, 30)
                                                .cuboid(11.0f, -15.0f, -3.0f, 6.0f, 2.0f, 6.0f, new Dilation(0.0f)).uv(16, 115).cuboid(10.0f, -13.0f, -4.0f, 8.0f, 5.0f, 8.0f, new Dilation(0.0f)),
                                ModelTransform.pivot(5.0f, 4.0f, 0.0f));

                ModelPartData cube_r1 = side_booster_left.addChild("cube_r1",
                                ModelPartBuilder.create().uv(102, 124).cuboid(0.844f, -11.3692f, -1.0f, 11.0f, 2.0f, 2.0f, new Dilation(0.0f)).uv(102, 124).cuboid(-7.6412f, -19.8544f, -1.0f, 11.0f, 2.0f, 2.0f, new Dilation(0.0f)).uv(82, 85)
                                                .cuboid(-5.3778f, -18.591f, 0.0f, 23.0f, 15.0f, 0.0f, new Dilation(0.0f)).uv(102, 124).cuboid(8.6222f, -3.591f, -1.0f, 11.0f, 2.0f, 2.0f, new Dilation(0.0f)),
                                ModelTransform.of(-5.0f, -31.75f, 0.0f, 0.0f, 0.0f, 0.7854f));

                ModelPartData cube_r2 = side_booster_left.addChild("cube_r2",
                                ModelPartBuilder.create().uv(102, 124).cuboid(-11.844f, -11.3692f, -1.0f, 11.0f, 2.0f, 2.0f, new Dilation(0.0f)).uv(102, 124).cuboid(-3.3588f, -19.8544f, -1.0f, 11.0f, 2.0f, 2.0f, new Dilation(0.0f)).uv(82, 85).mirrored()
                                                .cuboid(-17.6222f, -18.591f, 0.0f, 23.0f, 15.0f, 0.0f, new Dilation(0.0f)).mirrored(false).uv(102, 124).cuboid(-19.6222f, -3.591f, -1.0f, 11.0f, 2.0f, 2.0f, new Dilation(0.0f)),
                                ModelTransform.of(-5.0f, -31.75f, 0.0f, 0.0f, 0.0f, -0.7854f));
                ...
                ModelPartData main = rocket.addChild("main",
                                ModelPartBuilder.create().uv(36, -18).cuboid(-9.0f, -74.0f, -9.0f, 0.0f, 59.0f, 18.0f, new Dilation(0.0f)).uv(36, -18).cuboid(9.0f, -74.0f, -9.0f, 0.0f, 59.0f, 18.0f, new Dilation(0.0f)).uv(36, 0)
                                                ...
                                                .cuboid(-6.0f, -54.0f, -10.0f, 12.0f, 12.0f, 1.0f, new Dilation(0.0f)).uv(62, 58).cuboid(4.0f, -52.0f, -10.0f, 0.0f, 8.0f, 1.0f, new Dilation(0.0f)),
                ...
                ModelPartData pyramid = main.addChild("pyramid",
                                ModelPartBuilder.create().uv(73, 29).cuboid(-6.0f, -77.5f, -5.0f, 0.0f, 9.0f, 10.0f, new Dilation(0.0f)).uv(73, 29).cuboid(6.0f, -77.5f, -5.0f, 0.0f, 9.0f, 10.0f, new Dilation(0.0f)).uv(88, 102)
                                                .cuboid(10.0f, -58.0f, -10.0f, 0.0f, 2.0f, 20.0f, new Dilation(0.0f)).uv(88, 102).cuboid(-10.0f, -58.0f, -10.0f, 0.0f, 2.0f, 20.0f, new Dilation(0.0f)).uv(88, 122)
                                                .cuboid(-10.0f, -58.0f, 10.0f, 20.0f, 2.0f, 0.0f, new Dilation(0.0f)).uv(88, 122).cuboid(-10.0f, -58.0f, -10.0f, 20.0f, 2.0f, 0.0f, new Dilation(0.0f)),
                ...
                ModelPartData cube_r12 = pyramid.addChild("cube_r12", ModelPartBuilder.create().uv(73, 29).cuboid(-6.0f, -4.5f, -5.0f, 0.0f, 9.0f, 10.0f, new Dilation(0.0f)).uv(73, 29).cuboid(6.0f, -4.5f, -5.0f, 0.0f, 9.0f, 10.0f, new Dilation(0.0f)),
                                ModelTransform.of(0.0f, -73.0f, 0.0f, 0.0f, -1.5708f, 0.0f));
                ...
                ModelPartData booster = main.addChild("booster",
                                ModelPartBuilder.create().uv(0, 114).cuboid(-6.0f, -15.0f, -6.0f, 12.0f, 6.0f, 0.0f, new Dilation(0.0f)).uv(0, 102).cuboid(6.0f, -15.0f, -6.0f, 0.0f, 6.0f, 12.0f, new Dilation(0.0f)).uv(0, 102)
                                                .cuboid(-6.0f, -15.0f, -6.0f, 0.0f, 6.0f, 12.0f, new Dilation(0.0f)).uv(0, 114).cuboid(-6.0f, -15.0f, 6.0f, 12.0f, 6.0f, 0.0f, new Dilation(0.0f)).uv(0, 91)
                                                .cuboid(7.0f, -9.0f, -7.0f, 0.0f, 9.0f, 14.0f, new Dilation(0.0f)).uv(0, 105).cuboid(-7.0f, -9.0f, 7.0f, 14.0f, 9.0f, 0.0f, new Dilation(0.0f)).uv(0, 91)
                                                .cuboid(-7.0f, -9.0f, -7.0f, 0.0f, 9.0f, 14.0f, new Dilation(0.0f)).uv(-14, 77).cuboid(-7.0f, -9.0f, -7.0f, 14.0f, 0.0f, 14.0f, new Dilation(0.0f)).uv(-14, 91)
                                                .cuboid(-7.0f, 0.0f, -7.0f, 14.0f, 0.0f, 14.0f, new Dilation(0.0f)).uv(0, 105).cuboid(-7.0f, -9.0f, -7.0f, 14.0f, 9.0f, 0.0f, new Dilation(0.0f)),
                                ModelTransform.pivot(0.0f, 0.0f, 0.0f));

                ModelPartData tip = main.addChild("tip",
                                ModelPartBuilder.create().uv(80, 0).cuboid(-4.0f, -110.0f, -4.0f, 8.0f, 8.0f, 8.0f, new Dilation(0.0f)).uv(80, 16).cuboid(-3.0f, -118.0f, -3.0f, 6.0f, 8.0f, 6.0f, new Dilation(0.0f)).uv(104, 0)
                                                .cuboid(-2.0f, -120.0f, -2.0f, 4.0f, 2.0f, 4.0f, new Dilation(0.0f)).uv(0, 120).cuboid(-2.0f, -135.0f, -2.0f, 4.0f, 4.0f, 4.0f, new Dilation(0.0f)).uv(104, 0)
                                                .cuboid(-2.0f, -123.0f, -2.0f, 4.0f, 2.0f, 4.0f, new Dilation(0.0f)).uv(120, 0).cuboid(-1.0f, -131.0f, -1.0f, 2.0f, 11.0f, 2.0f, new Dilation(0.0f)),
                                ModelTransform.pivot(0.0f, 0.0f, 0.0f));
