...
public class GlacianRamEntityModel<T extends GlacianRamEntity> extends QuadrupedEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = modelPartData.addChild("head",
                ModelPartBuilder.create().uv(3, 19).cuboid(-3.5f, -4.8f, -2.9f, 7.0f, 6.0f, 7.0f, new Dilation(0.0f)).uv(50, 53).cuboid(1.5f, -6.8f, -0.9f, 4.0f, 2.0f, 2.0f, new Dilation(0.0f)).uv(32, 52)
                        .cuboid(3.5f, -6.8f, 1.1f, 2.0f, 2.0f, 2.0f, new Dilation(0.0f)).uv(51, 56).cuboid(-5.5f, -6.8f, 1.1f, 2.0f, 2.0f, 2.0f, new Dilation(0.0f)).uv(52, 18).cuboid(-5.5f, -6.8f, -0.9f, 4.0f, 2.0f, 2.0f, new Dilation(0.0f)),
                ModelTransform.of(0.0f, 13.8f, -1.9f, 0.0f, 3.1416f, 0.0f));
        ...
        ModelPartData body = modelPartData.addChild("body",
                ModelPartBuilder.create().uv(0, 40).cuboid(-1.5f, -2.4f, -7.6f, 3.0f, 2.0f, 3.0f, new Dilation(0.0f)).uv(0, 40).cuboid(5.5f, 1.6f, -0.6f, 0.0f, 2.0f, 6.0f, new Dilation(0.0f)).uv(0, 0)
                        .cuboid(-5.5f, -6.4f, -0.6f, 11.0f, 8.0f, 10.0f, new Dilation(0.0f)).uv(27, 27).cuboid(-5.5f, -4.4f, -5.6f, 11.0f, 6.0f, 5.0f, new Dilation(0.0f)).uv(0, 40).cuboid(-5.5f, 1.6f, -0.6f, 0.0f, 2.0f, 6.0f, new Dilation(0.0f)),
                ModelTransform.of(0.0f, 18.4f, 6.6f, 0.0f, 3.1416f, 0.0f));
