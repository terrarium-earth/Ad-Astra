...
public class LunarianTradeOffers {
	public static final Map<VillagerProfession, Int2ObjectMap<Factory[]>> PROFESSION_TO_LEVELED_TRADE = Util.make(Maps.newHashMap(), map -> {
		...
		map.put(VillagerProfession.SHEPHERD,
				copyToFastUtilMap(ImmutableMap.of(1,
						...
						new Factory[]{new BuyForOneEmeraldFactory(Items.BROWN_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.PURPLE_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.BLUE_DYE, 12, 16, 30),
								new BuyForOneEmeraldFactory(Items.GREEN_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.MAGENTA_DYE, 12, 16, 30), new BuyForOneEmeraldFactory(Items.CYAN_DYE, 12, 16, 30), new SellItemFactory(ModItems.FLAG, 3, 1, 12, 25),
								new SellItemFactory(ModItems.FLAG_BLUE, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_LIGHT_BLUE, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_RED, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_PINK, 3, 1, 12, 25),
								new SellItemFactory(ModItems.FLAG_GREEN, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_LIME, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_GRAY, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_PURPLE, 3, 1, 12, 25),
								new SellItemFactory(ModItems.FLAG_MAGENTA, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_CYAN, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_BROWN, 3, 1, 12, 25),
								new SellItemFactory(ModItems.FLAG_YELLOW, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_ORANGE, 3, 1, 12, 25)},
		...
		map.put(VillagerProfession.CARTOGRAPHER,
				copyToFastUtilMap(ImmutableMap.of(1, new Factory[]{new BuyForOneEmeraldFactory(Items.PAPER, 24, 16, 2), new SellItemFactory(Items.MAP, 7, 1, 1)}, 2, new Factory[]{new BuyForOneEmeraldFactory(Items.GLASS_PANE, 11, 16, 10)}, 3,
						new Factory[]{new BuyForOneEmeraldFactory(Items.COMPASS, 1, 12, 20),}, 4,
						new Factory[]{new SellItemFactory(Items.ITEM_FRAME, 7, 1, 15), new SellItemFactory(ModItems.FLAG, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_BLUE, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_LIGHT_BLUE, 3, 1, 12, 25),
								new SellItemFactory(ModItems.FLAG_RED, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_PINK, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_GREEN, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_LIME, 3, 1, 12, 25),
								new SellItemFactory(ModItems.FLAG_GRAY, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_PURPLE, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_MAGENTA, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_CYAN, 3, 1, 12, 25),
								new SellItemFactory(ModItems.FLAG_BROWN, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_YELLOW, 3, 1, 12, 25), new SellItemFactory(ModItems.FLAG_ORANGE, 3, 1, 12, 25)},
		...
		map.put(VillagerProfession.TOOLSMITH,
				copyToFastUtilMap(ImmutableMap.of(1,
						new Factory[]{new BuyForOneEmeraldFactory(ModItems.ICE_SHARD, 12, 16, 2), new SellItemFactory(new ItemStack(Items.SOUL_TORCH), 3, 16, 8, 1, 0.2f), new SellItemFactory(new ItemStack(ModItems.HAMMER), 3, 1, 8, 2, 0.2f),
								new SellItemFactory(new ItemStack(Items.STONE_AXE), 1, 1, 12, 1, 0.2f), new SellItemFactory(new ItemStack(Items.STONE_SHOVEL), 1, 1, 12, 1, 0.2f), new SellItemFactory(new ItemStack(Items.STONE_PICKAXE), 1, 1, 12, 1, 0.2f),
	...
	public static final Int2ObjectMap<Factory[]> WANDERING_TRADER_TRADES = copyToFastUtilMap(ImmutableMap.of(1,
			new Factory[]{new SellItemFactory(ModItems.CHEESE, 1, 3, 6, 1), new SellItemFactory(ModItems.SPACE_PAINTING, 48, 1, 2, 2), new SellItemFactory(ModItems.OXYGEN_TANK, 10, 1, 3, 1), new SellItemFactory(Items.SOUL_TORCH, 1, 12, 12, 1),
					new SellItemFactory(Items.SOUL_CAMPFIRE, 3, 1, 4, 1), new SellItemFactory(ModItems.HAMMER, 3, 1, 4, 1), new SellItemFactory(ModItems.FLAG, 10, 1, 3, 2), new SellItemFactory(ModItems.SPACE_HELMET, 10, 1, 2, 1),
					new SellItemFactory(ModItems.SPACE_SUIT, 16, 1, 2, 1), new SellItemFactory(ModItems.SPACE_PANTS, 14, 1, 2, 1), new SellItemFactory(ModItems.SPACE_BOOTS, 8, 1, 2, 1), new SellItemFactory(Items.COAL, 1, 5, 4, 1),
					new SellItemFactory(ModItems.OXYGEN_BUCKET, 10, 1, 2, 2), new SellItemFactory(Items.WATER_BUCKET, 5, 1, 4, 1), new SellItemFactory(Items.LAVA_BUCKET, 3, 1, 4, 1), new BuyForOneEmeraldFactory(ModItems.DESH_INGOT, 4, 20, 1),
					new BuyForOneEmeraldFactory(ModItems.OSTRUM_INGOT, 4, 20, 1), new BuyForOneEmeraldFactory(ModItems.CALORITE_INGOT, 4, 20, 1)},
