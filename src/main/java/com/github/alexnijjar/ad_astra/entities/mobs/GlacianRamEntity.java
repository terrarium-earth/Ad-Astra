...
import com.github.alexnijjar.ad_astra.entities.mobs.goal.EatPermafrostGoal;
...
public class GlacianRamEntity extends AnimalEntity implements Shearable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.1, Ingredient.ofItems(ModItems.ICE_SHARD), false));
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return stack.isOf(ModItems.ICE_SHARD);
    }
    ...
    public GlacianRamEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
        GlacianRamEntity glacianRamEntity = ModEntityTypes.GLACIAN_RAM.create(serverWorld);
