...
// 		widgets.add(widget);
// 		widgets.add(Widgets.withTooltip(Widgets.withBounds(widget, bounds), Text.translatable("rei.tooltip.ad_astra.energy_using", AdAstra.CONFIG.fuelRefinery.energyPerTick)));
