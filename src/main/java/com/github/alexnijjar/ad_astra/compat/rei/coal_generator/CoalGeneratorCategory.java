...
// 		widgets.add(widget);
// 		widgets.add(Widgets.withTooltip(Widgets.withBounds(widget, bounds), Text.translatable("rei.tooltip.ad_astra.energy_generating", AdAstra.CONFIG.coalGenerator.energyPerTick)));

// 		Text ratioText = Text.translatable("rei.text.ad_astra.generates", display.recipe().getCookTime() * AdAstra.CONFIG.coalGenerator.energyPerTick);
