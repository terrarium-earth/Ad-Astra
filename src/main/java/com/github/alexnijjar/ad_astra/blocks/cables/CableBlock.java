...
// super(settings);
// this.setDefaultState(getDefaultState().with(UP, false).with(DOWN, false).with(NORTH, false).with(EAST, false).with(SOUTH,
// false).with(WEST, false).with(WATERLOGGED, false));
// }
