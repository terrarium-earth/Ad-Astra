...
public class ModSoundEvents {
    ...
    public static final RegistryEntry<SoundEvent> ROCKET_LAUNCH = SOUND_EVENTS.register("rocket_launch", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "rocket_launch")));

    public static final RegistryEntry<SoundEvent> ROCKET = SOUND_EVENTS.register("rocket", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "rocket")));

    public static final RegistryEntry<SoundEvent> WRENCH = SOUND_EVENTS.register("wrench", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "wrench")));

    public static final RegistryEntry<SoundEvent> SLIDING_DOOR_CLOSE = SOUND_EVENTS.register("sliding_door_close", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "sliding_door_close")));

    public static final RegistryEntry<SoundEvent> SLIDING_DOOR_OPEN = SOUND_EVENTS.register("sliding_door_open", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "sliding_door_open")));

    public static final RegistryEntry<SoundEvent> OXYGEN_INTAKE = SOUND_EVENTS.register("oxygen_intake", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "oxygen_intake")));

    public static final RegistryEntry<SoundEvent> OXYGEN_OUTTAKE = SOUND_EVENTS.register("oxygen_outtake", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "oxygen_outtake")));

    public static final RegistryEntry<SoundEvent> GRAVITY_NORMALIZER_IDLE = SOUND_EVENTS.register("gravity_normalizer_idle", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "gravity_normalizer_idle")));
}
