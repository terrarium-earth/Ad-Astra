...
public abstract class PlanetProvider implements DataProvider {
    ...
    public PlanetProvider(PackOutput output) {
        this.pathProvider = output.createPathProvider(PackOutput.Target.DATA_PACK, "planet_data/planets");
    }
    ...
    public CompletableFuture<?> run(CachedOutput output) {
        ...
        this.buildPlanets(planet -> {
            ...
            Path path = this.pathProvider.json(planet.planet().location());
