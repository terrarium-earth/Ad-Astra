...
public class CorruptedLunarianEntityModel extends EntityModel<CorruptedLunarianEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		// body.
		modelPartData.addChild("body", ModelPartBuilder.create().uv(16, 20).mirrored().cuboid(-4.0f, 0.0f, -3.0f, 8.0f, 12.0f, 6.0f, new Dilation(0.0f)).mirrored(false).uv(0, 38).mirrored().cuboid(-4.0f, 0.0f, -3.0f, 8.0f, 20.0f, 6.0f, new Dilation(0.5f)).mirrored(false), ModelTransform.of(0.0f, 0.0f, -3.0f, 0.2182f, 0.0f, 0.0f));
