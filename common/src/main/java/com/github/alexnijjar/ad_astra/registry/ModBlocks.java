...
public class ModBlocks {
	...
	// Flag Blocks
	public static final RegistrySupplier<Block> WHITE_FLAG = register("white_flag", new FlagBlock(AbstractBlock.Settings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(1.0f, 1.0f)));
	public static final RegistrySupplier<Block> BLACK_FLAG = register("black_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> BLUE_FLAG = register("blue_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> BROWN_FLAG = register("brown_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> CYAN_FLAG = register("cyan_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> GRAY_FLAG = register("gray_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> GREEN_FLAG = register("green_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> LIGHT_BLUE_FLAG = register("light_blue_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> LIGHT_GRAY_FLAG = register("light_gray_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> LIME_FLAG = register("lime_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> MAGENTA_FLAG = register("magenta_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> ORANGE_FLAG = register("orange_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> PINK_FLAG = register("pink_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> PURPLE_FLAG = register("purple_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> RED_FLAG = register("red_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));
	public static final RegistrySupplier<Block> YELLOW_FLAG = register("yellow_flag", new FlagBlock(AbstractBlock.Settings.copy(WHITE_FLAG.get())));

	// Globes
	public static final RegistrySupplier<Block> EARTH_GLOBE = register("earth_globe", new GlobeBlock(AbstractBlock.Settings.of(Material.STONE).sounds(BlockSoundGroup.STONE).strength(3.5f).nonOpaque().requiresTool()));
	public static final RegistrySupplier<Block> MOON_GLOBE = register("moon_globe", new GlobeBlock(AbstractBlock.Settings.copy(EARTH_GLOBE.get())));
	public static final RegistrySupplier<Block> MARS_GLOBE = register("mars_globe", new GlobeBlock(AbstractBlock.Settings.copy(EARTH_GLOBE.get())));
	public static final RegistrySupplier<Block> MERCURY_GLOBE = register("mercury_globe", new GlobeBlock(AbstractBlock.Settings.copy(EARTH_GLOBE.get())));
	public static final RegistrySupplier<Block> VENUS_GLOBE = register("venus_globe", new GlobeBlock(AbstractBlock.Settings.copy(EARTH_GLOBE.get())));
	public static final RegistrySupplier<Block> GLACIO_GLOBE = register("glacio_globe", new GlobeBlock(AbstractBlock.Settings.copy(EARTH_GLOBE.get())));
	...
	public static final RegistrySupplier<Block> DESH_FLUID_PIPE = register("desh_fluid_pipe", new FluidPipeBlock(FluidUtils.millibucketsToDroplets(25), 1, 0.312, AbstractBlock.Settings.of(Material.METAL).sounds(BlockSoundGroup.NETHERITE).strength(1.0f, 1.0f)));
	public static final RegistrySupplier<Block> OSTRUM_FLUID_PIPE = register("ostrum_fluid_pipe", new FluidPipeBlock(FluidUtils.millibucketsToDroplets(50), 1, 0.312, AbstractBlock.Settings.of(Material.METAL).sounds(BlockSoundGroup.NETHERITE).strength(1.0f, 1.0f)));
	...
	public static final RegistrySupplier<Block> COMPRESSOR = register("compressor", new CompressorBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get())));
	public static final RegistrySupplier<Block> COAL_GENERATOR = register("coal_generator", new CoalGeneratorBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get())));
	public static final RegistrySupplier<Block> OXYGEN_LOADER = register("oxygen_loader", new OxygenLoaderBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get())));
	public static final RegistrySupplier<Block> SOLAR_PANEL = register("solar_panel", new SolarPanelBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get())));
	public static final RegistrySupplier<Block> NASA_WORKBENCH = register("nasa_workbench", new NasaWorkbenchBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get()).nonOpaque()));
	public static final RegistrySupplier<Block> OXYGEN_DISTRIBUTOR = register("oxygen_distributor", new OxygenDistributorBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get())));
	public static final RegistrySupplier<Block> WATER_PUMP = register("water_pump", new WaterPumpBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get()).nonOpaque()));
	public static final RegistrySupplier<Block> ENERGIZER = register("energizer", new EnergizerBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get()).nonOpaque()));
	public static final RegistrySupplier<Block> CRYO_FREEZER = register("cryo_freezer", new CryoFreezerBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get())));
	public static final RegistrySupplier<Block> OXYGEN_SENSOR = register("oxygen_sensor", new OxygenSensorBlock(AbstractBlock.Settings.copy(FUEL_REFINERY.get())));
	...
	public static final RegistrySupplier<FluidBlock> OIL_BLOCK = ModBlocks.register("oil", new FluidBlock(ModFluids.OIL_STILL.get(), AbstractBlock.Settings.copy(Blocks.WATER).strength(100.0f).dropsNothing()));
	public static final RegistrySupplier<FluidBlock> FUEL_BLOCK = ModBlocks.register("fuel", new FluidBlock(ModFluids.FUEL_STILL.get(), AbstractBlock.Settings.copy(Blocks.WATER).strength(100.0f).dropsNothing()));
