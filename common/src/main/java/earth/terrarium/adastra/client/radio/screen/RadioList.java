...
import earth.terrarium.adastra.common.networking.messages.ServerboundSetStationPacket;
    ...
    public class RadioEntry extends ListEntry {
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int button) {
            ...
            if (info != null && mouseX > 0 && mouseX < width + 3 && mouseY > 0 && mouseY < 12) {
                ...
                AdAstra.CONFIGURATOR.saveConfig(ClientConfig.class);
                update();
                return true;
            }
        ...
        private Component getName() {
            return info == null ? Component.translatable("text.adastra.radio.none") : Component.literal(info.title());
        }
