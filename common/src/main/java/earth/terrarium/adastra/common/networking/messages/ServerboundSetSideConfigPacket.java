    ...
    private static class Handler extends CodecPacketHandler<ServerboundSetSideConfigPacket> {
        public Handler() {
            super(ObjectByteCodec.create(
                ...
                new EnumCodec<>(Direction.class).fieldOf(ServerboundSetSideConfigPacket::direction),
                new EnumCodec<>(Configuration.class).fieldOf(ServerboundSetSideConfigPacket::configuration),
