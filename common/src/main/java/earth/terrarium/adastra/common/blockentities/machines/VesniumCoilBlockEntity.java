...
public class VesniumCoilBlockEntity extends MachineBlockEntity implements BotariumEnergyBlock<WrappedBlockEnergyContainer>, GeoBlockEntity {
    ...
    public VesniumCoilBlockEntity(BlockPos pos, BlockState state) {
        super(pos, state);
    }
