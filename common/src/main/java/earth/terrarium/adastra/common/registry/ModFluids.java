...
public final class ModFluids {
    ...
    public static final RegistryEntry<FlowingFluid> OIL = FLUIDS.register("oil", () -> new BotariumSourceFluid(ModFluidProperties.OIL));
    public static final RegistryEntry<FlowingFluid> FLOWING_OIL = FLUIDS.register("flowing_oil", () -> new BotariumFlowingFluid(ModFluidProperties.OIL));
}
