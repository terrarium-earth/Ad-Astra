...
public final class NetworkHandler {
    ...
    public static void init() {
        ...
        CHANNEL.registerPacket(NetworkDirection.CLIENT_TO_SERVER, ServerboundSyncJetSuitEnabled.ID, ServerboundSyncJetSuitEnabled.HANDLER, ServerboundSyncJetSuitEnabled.class);
    }
}
