...
public class ConstantComponents {
    ...
    public static final Component NOT_THE_OWNER = Component.translatable("message.ad_astra.flag.not_owner").withStyle(ChatFormatting.DARK_RED);

    public static final Component NOT_ENOUGH_FUEL = Component.translatable("message.ad_astra.not_enough_fuel").withStyle(ChatFormatting.DARK_RED);
    ...
    public static final Component SPACE_STATION_ALREADY_EXISTS = Component.translatable("gui.ad_astra.space_station.already_exists").withStyle(ChatFormatting.DARK_RED);
