...
public class AlloyingCategory implements DisplayCategory<AlloyingDisplay> {
    ...
    public List<Widget> setupDisplay(AlloyingDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createTexturedWidget(FURNACE_OVERLAY, bounds.x + 30, bounds.y + 52, 32, 43));
        ...
        widgets.add(new ReiEnergyBarWidget(new Point(bounds.x + 146, bounds.y + 67), -display.recipe().energy(), MachineConfig.STEEL.energyCapacity, MachineConfig.STEEL.maxEnergyInOut, 0));
