...
public class CompressingCategory implements DisplayCategory<CompressingDisplay> {
    ...
    public List<Widget> setupDisplay(CompressingDisplay display, Rectangle bounds) {
        ...
        widgets.add(new EnergyBarWidget(new Point(bounds.x + 144, bounds.y + 73), -display.recipe().energy(), MachineConfig.IRON.energyCapacity, MachineConfig.IRON.maxEnergyInOut, 0));
