...
public class LunarianWanderingTraderEntity extends WanderingTrader {

    public LunarianWanderingTraderEntity(EntityType<? extends WanderingTrader> entityType, Level level) {
