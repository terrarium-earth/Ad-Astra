...
public abstract class AbstractVehicleMenu extends AbstractContainerMenu {
    ...
    public AbstractVehicleMenu(MenuType<?> type, int syncId, Inventory inventory, Vehicle entity) {
        this(type, syncId, inventory, entity, new Slot[]{});
    }

    // Add additional slots.
    public AbstractVehicleMenu(MenuType<?> type, int syncId, Inventory inventory, Vehicle entity, Slot[] slots) {
        super(type, syncId);
        this.vehicle = entity;
