...
public class SulfurCreeperEntityModel<T extends Entity> extends EntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(50, 9).cuboid(0.0F, -17.0F, 0.0F, 0.0F, 9.0F, 7.0F, new Dilation(0.0F)).uv(16, 16).cuboid(-4.0F, -18.0F, -2.0F, 8.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

        ModelPartData sulfurcrystalbodyR_r1 = body.addChild("sulfurcrystalbodyR_r1", ModelPartBuilder.create().uv(50, 0).cuboid(3.4317F, -7.4874F, -1.9048F, 10.0F, 7.0F, 0.0F, new Dilation(0.0F)).uv(50, 0).cuboid(14.4317F, -8.4874F, 0.0952F, 6.0F, 2.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(11.0F, -17.0F, 2.0F, 0.0983F, 0.0831F, 2.9853F));
