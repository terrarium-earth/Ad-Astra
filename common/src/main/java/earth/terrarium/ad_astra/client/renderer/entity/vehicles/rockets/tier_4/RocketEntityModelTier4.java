...
public class RocketEntityModelTier4 extends VehicleEntityModel<RocketTier4> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ModResourceLocation("tier_4_rocket"), "main");
