...
import earth.terrarium.ad_astra.entity.vehicle.RocketTier3;
...
public class RocketModelTier3 extends VehicleModel<RocketTier3> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AdAstra.MOD_ID, "tier_3_rocket"), "main");

    public RocketModelTier3(ModelPart root) {
        super(root, "rocket");
    }
