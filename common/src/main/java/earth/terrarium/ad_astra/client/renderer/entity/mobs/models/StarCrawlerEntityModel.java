...
public class StarCrawlerEntityModel extends EntityModel<StarCrawlerEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        // Body.
        modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-8.0f, -13.0f, -8.0f, 16.0f, 10.0f, 16.0f, new Dilation(0.0f)).uv(0, 26).cuboid(-7.0f, -9.0f, -7.0f, 14.0f, 9.0f, 14.0f, new Dilation(0.0f)), ModelTransform.pivot(0.0f, 24.0f, 0.0f));

        ModelPartData arm1g = modelPartData.addChild("arm1g", ModelPartBuilder.create(), ModelTransform.pivot(0.0f, 18.3f, 6.75f));

        ModelPartData Arm1 = arm1g.addChild("Arm1", ModelPartBuilder.create().uv(48, 48).cuboid(-6.0f, -5.2f, 0.25f, 12.0f, 8.0f, 8.0f, new Dilation(0.0f)).uv(42, 26).cuboid(-5.0f, 2.8f, -1.75f, 10.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.pivot(0.0f, 0.0f, 0.0f));
        ...
        ModelPartData Limb1 = arm1g.addChild("Limb1", ModelPartBuilder.create().uv(48, 0).cuboid(-5.0f, -4.3f, 0.25f, 10.0f, 7.0f, 9.0f, new Dilation(0.0f)).uv(0, 64).cuboid(-4.0f, 2.7f, -0.75f, 8.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.pivot(0.0f, 0.0f, 7.0f));
        ...
        ModelPartData Hand1 = arm1g.addChild("Hand1", ModelPartBuilder.create().uv(0, 49).cuboid(-4.0f, -3.3f, 0.25f, 8.0f, 6.0f, 9.0f, new Dilation(0.0f)).uv(25, 55).cuboid(-3.0f, 2.7f, -0.75f, 6.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.pivot(0.0f, 0.1f, 15.0f));
        ...
        ModelPartData Arm2 = arm2g.addChild("Arm2", ModelPartBuilder.create().uv(48, 48).cuboid(-6.0f, -5.2f, 0.25f, 12.0f, 8.0f, 8.0f, new Dilation(0.0f)).uv(42, 26).cuboid(-5.0f, 2.8f, -1.75f, 10.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(0.0f, -0.1f, 1.0f, 0.0f, 3.1416f, 0.0f));
        ...
        ModelPartData Limb2 = arm2g.addChild("Limb2", ModelPartBuilder.create().uv(48, 0).cuboid(-5.0f, -4.3f, 0.25f, 10.0f, 7.0f, 9.0f, new Dilation(0.0f)).uv(0, 64).cuboid(-4.0f, 2.7f, -0.75f, 8.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(0.0f, -0.1f, -6.0f, 0.0f, 3.1416f, 0.0f));
        ...
        ModelPartData Hand2 = arm2g.addChild("Hand2", ModelPartBuilder.create().uv(0, 49).cuboid(-4.0f, -3.3f, -4.75f, 8.0f, 6.0f, 9.0f, new Dilation(0.0f)).uv(25, 55).cuboid(-3.0f, 2.7f, -3.75f, 6.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.pivot(0.0f, 0.0f, -19.0f));
        ...
        ModelPartData Arm3 = arm3g.addChild("Arm3", ModelPartBuilder.create().uv(48, 48).cuboid(-6.0f, -5.2f, 0.25f, 12.0f, 8.0f, 8.0f, new Dilation(0.0f)).uv(42, 26).cuboid(-5.0f, 2.8f, -1.75f, 10.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(0.25f, -5.7f, 0.0f, 0.0f, -1.5708f, 0.0f));
        ...
        ModelPartData Limb3 = arm3g.addChild("Limb3", ModelPartBuilder.create().uv(48, 0).cuboid(-5.0f, -4.3f, 0.25f, 10.0f, 7.0f, 9.0f, new Dilation(0.0f)).uv(0, 64).cuboid(-4.0f, 2.7f, -0.75f, 8.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(-6.75f, -5.7f, 0.0f, 0.0f, -1.5708f, 0.0f));
        ...
        ModelPartData Hand3 = arm3g.addChild("Hand3", ModelPartBuilder.create().uv(0, 49).cuboid(-4.0f, -3.3f, 0.25f, 8.0f, 6.0f, 9.0f, new Dilation(0.0f)).uv(25, 55).cuboid(-3.0f, 2.7f, -0.75f, 6.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(-14.75f, -5.6f, 0.0f, 0.0f, -1.5708f, 0.0f));
        ...
        ModelPartData Arm4 = arm4g.addChild("Arm4", ModelPartBuilder.create().uv(48, 48).cuboid(-6.0f, -5.2f, 0.25f, 12.0f, 8.0f, 8.0f, new Dilation(0.0f)).uv(42, 26).cuboid(-5.0f, 2.8f, -1.75f, 10.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(-1.25f, -5.7f, 0.0f, 0.0f, 1.5708f, 0.0f));
        ...
        ModelPartData Limb4 = arm4g.addChild("Limb4", ModelPartBuilder.create().uv(48, 0).cuboid(-5.0f, -4.3f, 0.25f, 10.0f, 7.0f, 9.0f, new Dilation(0.0f)).uv(0, 64).cuboid(-4.0f, 2.7f, -0.75f, 8.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(5.75f, -5.7f, 0.0f, 0.0f, 1.5708f, 0.0f));
        ...
        ModelPartData Hand4 = arm4g.addChild("Hand4", ModelPartBuilder.create().uv(0, 49).cuboid(-4.0f, -3.3f, 0.25f, 8.0f, 6.0f, 9.0f, new Dilation(0.0f)).uv(25, 55).cuboid(-3.0f, 2.7f, -0.75f, 6.0f, 3.0f, 9.0f, new Dilation(0.0f)), ModelTransform.of(13.75f, -5.6f, 0.0f, 0.0f, 1.5708f, 0.0f));
