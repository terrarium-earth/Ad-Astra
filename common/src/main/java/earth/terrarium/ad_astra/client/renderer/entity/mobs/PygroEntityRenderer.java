...
public class PygroEntityRenderer extends PiglinRenderer {
    ...
    public PygroEntityRenderer(EntityRendererProvider.Context context) {
        super(context, PygroEntityModel.LAYER_LOCATION, ModelLayers.PIGLIN_INNER_ARMOR, ModelLayers.PIGLIN_OUTER_ARMOR, false);
    }
