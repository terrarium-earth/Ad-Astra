...
public class RocketEntityModelTier1 extends VehicleEntityModel<RocketTier1> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ModResourceLocation("tier_1_rocket"), "main");
