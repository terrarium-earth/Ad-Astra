...
public class ModEntityTypes {
    ...
    public static final RegistryEntry<EntityType<AirVortex>> AIR_VORTEX = ENTITY_TYPES.register("air_vortex", () -> EntityType.Builder.<AirVortex>of(AirVortex::new, MobCategory.MISC).sized(1.0f, 1.0f).noSave().fireImmune().noSummon().build(AdAstra.MOD_ID));
