...
public class FluidBarWidget extends EnergyBarWidget {
    ...
    public void renderBackground(GuiGraphics graphics, boolean dark, float alpha) {
        ...
        ScreenUtils.addTexture(graphics, this.bounds.x - 5, this.bounds.y - 3, 24, 59, REIUtils.FLUID_TANK_BACK_TEXTURE);
        ...
        if (this.increasing) {
            GuiUtil.drawFluidTank(graphics, this.bounds.x, this.bounds.y, 1.0f - ratio, fluid);
        } else {
            GuiUtil.drawFluidTank(graphics, this.bounds.x, this.bounds.y, ratio, fluid);
        }
