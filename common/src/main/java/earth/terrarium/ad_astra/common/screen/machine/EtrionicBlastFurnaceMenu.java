...
import earth.terrarium.ad_astra.common.block.machine.entity.EtrionicBlastFurnaceBlockEntity;
...
public class EtrionicBlastFurnaceMenu extends AbstractModContainerMenu<EtrionicBlastFurnaceBlockEntity> {
    ...
    public EtrionicBlastFurnaceMenu(int id, Inventory inv, FriendlyByteBuf buf) {
        this(id, inv, getTileFromBuf(inv.player.level, buf, EtrionicBlastFurnaceBlockEntity.class));
    }
