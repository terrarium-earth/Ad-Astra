...
public class ModSoundEvents {
    public static final RegistryHolder<SoundEvent> SOUND_EVENTS = new RegistryHolder<>(Registry.SOUND_EVENT, AdAstra.MOD_ID);
    ...
    private static Supplier<SoundEvent> register(String id) {
        return SOUND_EVENTS.register(id, () -> new SoundEvent(new ResourceLocation(AdAstra.MOD_ID, id)));
    }
}
