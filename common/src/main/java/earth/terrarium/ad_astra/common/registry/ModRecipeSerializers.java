...
public class ModRecipeSerializers {
    ...
    public static final Supplier<RecipeSerializer<FuelConversionRecipe>> FUEL_CONVERSION_SERIALIZER = register("fuel_conversion", () -> new CodecRecipeSerializer<>(ModRecipeTypes.FUEL_CONVERSION_RECIPE.get(), FuelConversionRecipe::codec));
