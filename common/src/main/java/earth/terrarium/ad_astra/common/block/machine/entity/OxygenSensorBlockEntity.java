    ...
    public void serverTick() {
        ...
        if (level.getGameTime() % 20 == 0) {
            ...
            for (Direction dir : Direction.values()) {
                if (OxygenSystem.posHasOxygen(level, worldPosition.relative(dir))) {
                    hasOxygen = true;
            ...
            level.setBlockAndUpdate(getBlockPos(), getBlockState().setValue(MachineBlock.POWERED, hasOxygen));
        }
    }
}
