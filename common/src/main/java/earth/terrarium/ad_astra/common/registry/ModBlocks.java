...
public class ModBlocks {
    ...
    public static final RegistryEntry<Block> THERMALYTE_BLOCK = STORAGE_BLOCKS.register("thermalyte_block", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
