...
public class WaterPumpMenu extends AbstractModContainerMenu<WaterPumpBlockEntity> {

    public WaterPumpMenu(int id, Inventory inv, WaterPumpBlockEntity entity) {
        super(ModMenus.WATER_PUMP.get(), id, inv, entity);
    }

    public WaterPumpMenu(int id, Inventory inv, FriendlyByteBuf buf) {
        this(id, inv, getTileFromBuf(inv.player.level, buf, WaterPumpBlockEntity.class));
    }
