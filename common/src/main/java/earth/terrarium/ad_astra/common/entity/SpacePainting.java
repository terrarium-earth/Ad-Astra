...
public class SpacePainting extends Painting {
    ...
    public static Optional<SpacePainting> place(Level level, BlockPos pos, Direction facing) {
        ...
        spacePaintings.removeIf(variant -> getSize(variant) < i);
    ...
    public void readAdditionalSaveData(CompoundTag nbt) {
        ...
        ((PaintingInvoker) this).invokeSetVariant(BuiltInRegistries.PAINTING_VARIANT.getHolder(registryKey).orElse(null));
        direction = Direction.from2DDataValue(nbt.getByte("Facing"));
    ...
    public void addAdditionalSaveData(CompoundTag nbt) {
        ...
        nbt.putString("Variant", BuiltInRegistries.PAINTING_VARIANT.getKey(getVariant().value()).toString());
