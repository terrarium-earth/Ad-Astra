...
public class ModItems {
    ...
    public static final RegistryEntry<Item> CABLE_DUCT = ITEMS.register("cable_duct", () -> new BlockItem(ModBlocks.CABLE_DUCT.get(), new Item.Properties().tab(ITEM_GROUP)));
    public static final RegistryEntry<Item> FLUID_PIPE_DUCT = ITEMS.register("fluid_pipe_duct", () -> new BlockItem(ModBlocks.FLUID_PIPE_DUCT.get(), new Item.Properties().tab(ITEM_GROUP)));
    ...
    public static final RegistryEntry<Item> VENT = ITEMS.register("vent", () -> new BlockItem(ModBlocks.VENT.get(), new Item.Properties().tab(ITEM_GROUP)));
