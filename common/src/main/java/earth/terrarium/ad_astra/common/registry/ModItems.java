...
public class ModItems {
    ...
    public static final RegistryEntry<Item> ASTRODUX = ITEMS.register("astrodux", () -> new AstroduxItem(new Item.Properties()));
    public static final RegistryEntry<Item> TIER_1_ROCKET = VEHICLES.register("tier_1_rocket", () -> new RocketItem<>(1, new Item.Properties().stacksTo(1).fireResistant()));
    public static final RegistryEntry<Item> TIER_2_ROCKET = VEHICLES.register("tier_2_rocket", () -> new RocketItem<>(2, new Item.Properties().stacksTo(1).fireResistant()));
    public static final RegistryEntry<Item> TIER_3_ROCKET = VEHICLES.register("tier_3_rocket", () -> new RocketItem<>(3, new Item.Properties().stacksTo(1).fireResistant()));
    public static final RegistryEntry<Item> TIER_4_ROCKET = VEHICLES.register("tier_4_rocket", () -> new RocketItem<>(4, new Item.Properties().stacksTo(1).fireResistant()));
    public static final RegistryEntry<Item> TIER_1_ROVER = VEHICLES.register("tier_1_rover", () -> new RoverItem(new Item.Properties().stacksTo(1).fireResistant()));
    public static final RegistryEntry<Item> LAUNCH_PAD = ITEMS.register("launch_pad", () -> new HoldableOverHeadBlockItem(ModBlocks.LAUNCH_PAD.get(), new Item.Properties()));

    public static final RegistryEntry<Item> OIL_BUCKET = ITEMS.register("oil_bucket", () -> new FluidBucketItem(ModFluidProperties.OIL_FLUID, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    public static final RegistryEntry<Item> FUEL_BUCKET = ITEMS.register("fuel_bucket", () -> new FluidBucketItem(ModFluidProperties.FUEL_FLUID, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    public static final RegistryEntry<Item> CRYO_FUEL_BUCKET = ITEMS.register("cryo_fuel_bucket", () -> new FluidBucketItem(ModFluidProperties.CRYO_FUEL_FLUID, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    public static final RegistryEntry<Item> HAMMER = ITEMS.register("hammer", () -> new HammerItem(new Item.Properties().stacksTo(1).durability(AdAstraConfig.hammerDurability)));
    ...
    public static final RegistryEntry<Item> FUEL_REFINERY = ITEMS.register("fuel_refinery", () -> new MachineBlockItem(ModBlocks.FUEL_REFINERY.get(), new Item.Properties(), "item.ad_astra.fuel_refinery.tooltip"));
    public static final RegistryEntry<Item> OXYGEN_LOADER = ITEMS.register("oxygen_loader", () -> new MachineBlockItem(ModBlocks.OXYGEN_LOADER.get(), new Item.Properties(), "item.ad_astra.oxygen_loader.tooltip[0]", "item.ad_astra.oxygen_loader.tooltip[1]"));
    public static final RegistryEntry<Item> SOLAR_PANEL = ITEMS.register("solar_panel", () -> new SolarPanelBlockItem(ModBlocks.SOLAR_PANEL.get(), new Item.Properties(), "item.ad_astra.solar_panel.tooltip[0]", "item.ad_astra.solar_panel.tooltip[1]"));
    public static final RegistryEntry<Item> OXYGEN_DISTRIBUTOR = ITEMS.register("oxygen_distributor", () -> new MachineBlockItem(ModBlocks.OXYGEN_DISTRIBUTOR.get(), new Item.Properties(), "item.ad_astra.oxygen_distributor.tooltip[0]", "item.ad_astra.oxygen_distributor.tooltip[1]"));
    public static final RegistryEntry<Item> WATER_PUMP = ITEMS.register("water_pump", () -> new MachineBlockItem(ModBlocks.WATER_PUMP.get(), new Item.Properties(), "item.ad_astra.water_pump.tooltip[0]", "item.ad_astra.water_pump.tooltip[1]"));
    public static final RegistryEntry<Item> ENERGIZER = ITEMS.register("energizer", () -> new EnergizerBlockItem(ModBlocks.ENERGIZER.get(), new Item.Properties().stacksTo(1), "item.ad_astra.energizer.tooltip[0]", "item.ad_astra.energizer.tooltip[1]"));
    public static final RegistryEntry<Item> CRYO_FREEZER = ITEMS.register("cryo_freezer", () -> new MachineBlockItem(ModBlocks.CRYO_FREEZER.get(), new Item.Properties().stacksTo(1), "item.ad_astra.cryo_freezer.tooltip"));
    public static final RegistryEntry<Item> OXYGEN_SENSOR = ITEMS.register("oxygen_sensor", () -> new MachineBlockItem(ModBlocks.OXYGEN_SENSOR.get(), new Item.Properties().stacksTo(1), "item.ad_astra.oxygen_sensor.tooltip[0]", "item.ad_astra.oxygen_sensor.tooltip[1]"));

    public static final RegistryEntry<Item> WHITE_FLAG = FLAGS.register("white_flag", () -> new FlagBlockItem(ModBlocks.WHITE_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> ORANGE_FLAG = FLAGS.register("orange_flag", () -> new FlagBlockItem(ModBlocks.ORANGE_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> MAGENTA_FLAG = FLAGS.register("magenta_flag", () -> new FlagBlockItem(ModBlocks.MAGENTA_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> LIGHT_BLUE_FLAG = FLAGS.register("light_blue_flag", () -> new FlagBlockItem(ModBlocks.LIGHT_BLUE_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> YELLOW_FLAG = FLAGS.register("yellow_flag", () -> new FlagBlockItem(ModBlocks.YELLOW_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> LIME_FLAG = FLAGS.register("lime_flag", () -> new FlagBlockItem(ModBlocks.LIME_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> PINK_FLAG = FLAGS.register("pink_flag", () -> new FlagBlockItem(ModBlocks.PINK_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> GRAY_FLAG = FLAGS.register("gray_flag", () -> new FlagBlockItem(ModBlocks.GRAY_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> LIGHT_GRAY_FLAG = FLAGS.register("light_gray_flag", () -> new FlagBlockItem(ModBlocks.LIGHT_GRAY_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> CYAN_FLAG = FLAGS.register("cyan_flag", () -> new FlagBlockItem(ModBlocks.CYAN_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> PURPLE_FLAG = FLAGS.register("purple_flag", () -> new FlagBlockItem(ModBlocks.PURPLE_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> BLUE_FLAG = FLAGS.register("blue_flag", () -> new FlagBlockItem(ModBlocks.BLUE_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> BROWN_FLAG = FLAGS.register("brown_flag", () -> new FlagBlockItem(ModBlocks.BROWN_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> GREEN_FLAG = FLAGS.register("green_flag", () -> new FlagBlockItem(ModBlocks.GREEN_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> RED_FLAG = FLAGS.register("red_flag", () -> new FlagBlockItem(ModBlocks.RED_FLAG.get(), new Item.Properties()));
    public static final RegistryEntry<Item> BLACK_FLAG = FLAGS.register("black_flag", () -> new FlagBlockItem(ModBlocks.BLACK_FLAG.get(), new Item.Properties()));

    public static final RegistryEntry<Item> EARTH_GLOBE = GLOBES.register("earth_globe", () -> new ModRenderedBlockItem(ModBlocks.EARTH_GLOBE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryEntry<Item> MOON_GLOBE = GLOBES.register("moon_globe", () -> new ModRenderedBlockItem(ModBlocks.MOON_GLOBE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryEntry<Item> MARS_GLOBE = GLOBES.register("mars_globe", () -> new ModRenderedBlockItem(ModBlocks.MARS_GLOBE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryEntry<Item> MERCURY_GLOBE = GLOBES.register("mercury_globe", () -> new ModRenderedBlockItem(ModBlocks.MERCURY_GLOBE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryEntry<Item> VENUS_GLOBE = GLOBES.register("venus_globe", () -> new ModRenderedBlockItem(ModBlocks.VENUS_GLOBE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryEntry<Item> GLACIO_GLOBE = GLOBES.register("glacio_globe", () -> new ModRenderedBlockItem(ModBlocks.GLACIO_GLOBE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));

    public static final RegistryEntry<Item> STEEL_INGOT = ITEMS.register("steel_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> DESH_INGOT = ITEMS.register("desh_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> OSTRUM_INGOT = ITEMS.register("ostrum_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> CALORITE_INGOT = ITEMS.register("calorite_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> ICE_SHARD = ITEMS.register("ice_shard", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> AERONOS_MUSHROOM = ITEMS.register("aeronos_mushroom", () -> new BlockItem(ModBlocks.AERONOS_MUSHROOM.get(), new Item.Properties()));
    public static final RegistryEntry<Item> STROPHAR_MUSHROOM = ITEMS.register("strophar_mushroom", () -> new BlockItem(ModBlocks.STROPHAR_MUSHROOM.get(), new Item.Properties()));
    ...
    public static final RegistryEntry<Item> DESH_PLATE = ITEMS.register("desh_plate", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> OSTRUM_PLATE = ITEMS.register("ostrum_plate", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> CALORITE_PLATE = ITEMS.register("calorite_plate", () -> new Item(new Item.Properties()));

    public static final RegistryEntry<Item> RAW_DESH = ITEMS.register("raw_desh", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> RAW_OSTRUM = ITEMS.register("raw_ostrum", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> RAW_CALORITE = ITEMS.register("raw_calorite", () -> new Item(new Item.Properties()));

    public static final RegistryEntry<Item> STEEL_NUGGET = ITEMS.register("steel_nugget", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> DESH_NUGGET = ITEMS.register("desh_nugget", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> OSTRUM_NUGGET = ITEMS.register("ostrum_nugget", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> CALORITE_NUGGET = ITEMS.register("calorite_nugget", () -> new Item(new Item.Properties()));

    public static final RegistryEntry<Item> IRON_ROD = ITEMS.register("iron_rod", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> OXYGEN_GEAR = ITEMS.register("oxygen_gear", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> WHEEL = ITEMS.register("wheel", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> ENGINE_FRAME = ITEMS.register("engine_frame", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> ENGINE_FAN = ITEMS.register("engine_fan", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> ROCKET_NOSE_CONE = ITEMS.register("rocket_nose_cone", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> STEEL_ENGINE = ITEMS.register("steel_engine", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> DESH_ENGINE = ITEMS.register("desh_engine", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> OSTRUM_ENGINE = ITEMS.register("ostrum_engine", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> CALORITE_ENGINE = ITEMS.register("calorite_engine", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> STEEL_TANK = ITEMS.register("steel_tank", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> DESH_TANK = ITEMS.register("desh_tank", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> OSTRUM_TANK = ITEMS.register("ostrum_tank", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> CALORITE_TANK = ITEMS.register("calorite_tank", () -> new Item(new Item.Properties()));
    public static final RegistryEntry<Item> ROCKET_FIN = ITEMS.register("rocket_fin", () -> new Item(new Item.Properties()));

    public static final RegistryEntry<Item> EXTINGUISHED_TORCH = ITEMS.register("extinguished_torch", () -> new StandingAndWallBlockItem(ModBlocks.EXTINGUISHED_TORCH.get(), ModBlocks.WALL_EXTINGUISHED_TORCH.get(), new Item.Properties(), Direction.DOWN));
    public static final RegistryEntry<Item> EXTINGUISHED_LANTERN = ITEMS.register("extinguished_lantern", () -> new BlockItem(ModBlocks.EXTINGUISHED_LANTERN.get(), new Item.Properties()));
    ...
    public static final RegistryEntry<Item> STEEL_DOOR = ITEMS.register("steel_door", () -> new BlockItem(ModBlocks.STEEL_DOOR.get(), new Item.Properties()));
    ...
    public static final RegistryEntry<Item> AERONOS_CHEST = ITEMS.register("aeronos_chest", () -> new ModRenderedBlockItem(ModBlocks.AERONOS_CHEST.get(), new Item.Properties()));
    public static final RegistryEntry<Item> AERONOS_DOOR = ITEMS.register("aeronos_door", () -> new BlockItem(ModBlocks.AERONOS_DOOR.get(), new Item.Properties()));
    ...
    public static final RegistryEntry<Item> STROPHAR_CHEST = ITEMS.register("strophar_chest", () -> new ModRenderedBlockItem(ModBlocks.STROPHAR_CHEST.get(), new Item.Properties()));
    public static final RegistryEntry<Item> STROPHAR_DOOR = ITEMS.register("strophar_door", () -> new BlockItem(ModBlocks.STROPHAR_DOOR.get(), new Item.Properties()));
    ...
    public static final RegistryEntry<Item> GLACIAN_DOOR = ITEMS.register("glacian_door", () -> new BlockItem(ModBlocks.GLACIAN_DOOR.get(), new Item.Properties()));
    ...
    public static final RegistryEntry<Item> GLACIAN_SIGN = ITEMS.register("glacian_sign", () -> new SignItem(new Item.Properties().stacksTo(16), ModBlocks.GLACIAN_SIGN.get(), ModBlocks.GLACIAN_WALL_SIGN.get()));
    ...
    public static final RegistryEntry<Item> LUNARIAN_SPAWN_EGG = ITEMS.register("lunarian_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.LUNARIAN, -13382401, -11650781, new Item.Properties()));
    public static final RegistryEntry<Item> CORRUPTED_LUNARIAN_SPAWN_EGG = ITEMS.register("corrupted_lunarian_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.CORRUPTED_LUNARIAN, -14804199, -16740159, new Item.Properties()));
    public static final RegistryEntry<Item> STAR_CRAWLER_SPAWN_EGG = ITEMS.register("star_crawler_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.STAR_CRAWLER, -13421773, -16724788, new Item.Properties()));
    public static final RegistryEntry<Item> MARTIAN_RAPTOR_SPAWN_EGG = ITEMS.register("martian_raptor_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.MARTIAN_RAPTOR, 5349438, -13312, new Item.Properties()));
    public static final RegistryEntry<Item> PYGRO_SPAWN_EGG = ITEMS.register("pygro_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.PYGRO, -3381760, -6750208, new Item.Properties()));
    public static final RegistryEntry<Item> ZOMBIFIED_PYGRO_SPAWN_EGG = ITEMS.register("zombified_pygro_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.ZOMBIFIED_PYGRO, 8473125, 6131271, new Item.Properties()));
    public static final RegistryEntry<Item> PYGRO_BRUTE_SPAWN_EGG = ITEMS.register("pygro_brute_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.PYGRO_BRUTE, -3381760, -67208, new Item.Properties()));
    public static final RegistryEntry<Item> MOGLER_SPAWN_EGG = ITEMS.register("mogler_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.MOGLER, -13312, -3407872, new Item.Properties()));
    public static final RegistryEntry<Item> ZOMBIFIED_MOGLER_SPAWN_EGG = ITEMS.register("zombified_mogler_spawn_egg", PlatformUtils.createSpawnEggItem(ModEntityTypes.ZOMBIFIED_MOGLER, 12537409, 7988821, new Item.Properties()));
