...
public class ModScreenHandlers {
    ...
    public static final Supplier<ScreenHandlerType<PlanetSelectionScreenHandler>> PLANET_SELECTION_SCREEN_HANDLER = SCREEN_HANDLERS.register("planet_selection_screen_handler", () -> RegistryHelpers.createMenuType((syncId, playerInventory, buf) -> new PlanetSelectionScreenHandler(syncId, playerInventory.player, buf)));    public static final Supplier<ScreenHandlerType<SolarPanelScreenHandler>> SOLAR_PANEL_SCREEN_HANDLER = SCREEN_HANDLERS.register("solar_panel_screen_handler", () -> RegistryHelpers.createMenuType(SolarPanelScreenHandler::new));
