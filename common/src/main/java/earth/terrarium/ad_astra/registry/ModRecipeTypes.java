...
public class ModRecipeTypes {
    ...
    public static final Supplier<ModRecipeType<FluidConversionRecipe>> FUEL_CONVERSION_RECIPE = register("fuel_conversion", () -> new ModRecipeType<>(new ModResourceLocation("nasa_workbench")));
    public static final Supplier<ModRecipeType<OxygenConversionRecipe>> OXYGEN_CONVERSION_RECIPE = register("oxygen_conversion", () -> new ModRecipeType<>(new ModResourceLocation("fuel_conversion")));
