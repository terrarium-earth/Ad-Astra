...
public class ModAdvancementProvider extends AdvancementProvider {
    ...
    public static class Advancements implements AdvancementGenerator {
        ...
        public void generate(HolderLookup.Provider writer, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
            ...
            AdvancementHolder carbonFootprint = Advancement.Builder.advancement()
                .parent(adAstra)
                .display(
            ...
            AdvancementHolder smartBlasting = Advancement.Builder.advancement()
            ...
            AdvancementHolder rocketScience = Advancement.Builder.advancement()
            ...
            AdvancementHolder dj = Advancement.Builder.advancement()
                .parent(astronaut)
                .display(
                    ModItems.RADIO.get(),
            ...
            AdvancementHolder zipGun = Advancement.Builder.advancement()
                .parent(dj)
                .display(
            ...
            AdvancementHolder rover = Advancement.Builder.advancement()
                .parent(dj)
                .display(
                    ModItems.ROVER.get(),
            ...
            AdvancementHolder tier1Rocket = Advancement.Builder.advancement()
                .parent(astronaut)
                .display(
            ...
            AdvancementHolder moon = Advancement.Builder.advancement()
                .parent(tier1Rocket)
                .display(
            ...
            AdvancementHolder moonCheese = Advancement.Builder.advancement()
                .parent(moon)
                .display(
                    ModItems.CHEESE.get(),
            ...
            AdvancementHolder solarPanel = Advancement.Builder.advancement()
                .parent(moon)
                .display(
            ...
            AdvancementHolder oxygenDistributor = Advancement.Builder.advancement()
                .parent(solarPanel)
                .display(
            ...
            AdvancementHolder gravityNormalizer = Advancement.Builder.advancement()
            ...
            AdvancementHolder tier2Rocket = Advancement.Builder.advancement()
                .parent(moon)
                .display(
            ...
            AdvancementHolder mars = Advancement.Builder.advancement()
                .parent(tier2Rocket)
                .display(
            ...
            AdvancementHolder doomSlayer = Advancement.Builder.advancement()
                .parent(mars)
                .display(
            ...
            AdvancementHolder energizer = Advancement.Builder.advancement()
                .parent(mars)
                .display(
            ...
            AdvancementHolder cryoFreezer = Advancement.Builder.advancement()
                .parent(mars)
                .display(
            ...
            AdvancementHolder tier3Rocket = Advancement.Builder.advancement()
                .parent(doomSlayer)
                .display(
            ...
            AdvancementHolder venus = Advancement.Builder.advancement()
                .parent(tier3Rocket)
                .display(
            ...
            AdvancementHolder mercury = Advancement.Builder.advancement()
                .parent(tier3Rocket)
                .display(
            ...
            AdvancementHolder tier4Rocket = Advancement.Builder.advancement()
                .parent(venus)
                .display(
            ...
            AdvancementHolder rocketMan = Advancement.Builder.advancement()
                .parent(venus)
                .display(
            ...
            AdvancementHolder interstellar = Advancement.Builder.advancement()
                .parent(tier4Rocket)
                .display(
